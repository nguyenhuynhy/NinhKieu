<%@ Control language="vb" CodeBehind="Terms.ascx.vb" AutoEventWireup="false" Explicit="True" Inherits="PortalQH.Terms" %>
<%@ Register TagPrefix="Portal" TagName="Title" Src="~/controls/DesktopModuleTitle.ascx"%>
<portal:title runat="server" id="Title1" DisplayTitle="Terms Of Use" />
<br>
<asp:Label ID="lblTerms" Runat="server" CssClass="Normal">
<span class="SubHead">AGREEMENT BETWEEN USER AND {PortalName}</span><br><br>
The {PortalName} Web Site is comprised of various Web 
pages operated by {PortalName}.<br><br>
The {PortalName} Web Site is 
...
{PortalName} Web Site constitutes your agreement to all such terms, 
...
{PortalName} Web Site is offered, including but not limited to the 
charges associated with the use of the {PortalName} Web Site.<br><br>
<span class="SubHead">LINKS TO THIRD PARTY SITES</span><br><br>
The {PortalName} Web Site may 
contain links to other Web Sites (“Linked Sites”). The Linked Sites are not 
under the control of {PortalName} and {PortalName} is not responsible 
...
{PortalName} is not responsible for webcasting or any other form of 
transmission received from any Linked Site. {PortalName} is providing 
these links to you only as a convenience, and the inclusion of any link does 
not imply endorsement by {PortalName} of the site or any association with 
its operators.<br><br>
<span class="SubHead">NO UNLAWFUL OR PROHIBITED USE</span><br><br>
As a condition of your use of the 
{PortalName} Web Site, you warrant to {PortalName} that you will not 
use the {PortalName} Web Site for any purpose that is unlawful or 
prohibited by these terms, conditions, and notices. You may not use the 
{PortalName} Web Site in any manner which could damage, disable, 
overburden, or impair the {PortalName} Web Site or interfere with any 
other party’s use and enjoyment of the {PortalName} Web Site. You may not 
obtain or attempt to obtain any materials or information through any means not 
intentionally made available or provided for through the {PortalName} Web 
Sites.<br><br>
...
{PortalName} has no obligation to monitor the Communication Services. 
However, {PortalName} reserves the right to review materials posted to a 
Communication Service and to remove any materials in its sole discretion. 
{PortalName} reserves the right to terminate your access to any or all of 
the Communication Services at any time without notice for any reason 
whatsoever.<br><br>
{PortalName} reserves the right at all times to disclose any 
...
information or materials, in whole or in part, in {PortalName}’s sole 
discretion.<br><br>
...
{PortalName} does not control or endorse the content, messages or 
information found in any Communication Service and, therefore, 
{PortalName} specifically disclaims any liability with regard to the 
Communication Services and any actions resulting from your participation in any 
Communication Service. Managers and hosts are not authorized {PortalName} 
...
<span class="SubHead">MATERIALS PROVIDED TO {PortalName} OR POSTED AT ANY {PortalName} WEB 
SITE</span><br><br>
{PortalName} does not claim ownership of the materials you provide to 
{PortalName} (including feedback and suggestions) or post, upload, input 
or submit to any {PortalName} Web Site or its associated services 
(collectively “Submissions”). However, by posting, uploading, inputting, 
providing or submitting your Submission you are granting {PortalName}, its 
...
provided herein. {PortalName} is under no obligation to post or use any 
Submission you may provide and may remove any Submission at any time in 
{PortalName}’s sole discretion.<br><br>
...
THE INFORMATION, SOFTWARE, PRODUCTS, AND SERVICES INCLUDED IN OR AVAILABLE THROUGH THE {PortalName} WEB SITE 
MAY INCLUDE INACCURACIES OR TYPOGRAPHICAL ERRORS. CHANGES ARE PERIODICALLY 
ADDED TO THE INFORMATION HEREIN. {PortalName} AND/OR ITS SUPPLIERS MAY 
MAKE IMPROVEMENTS AND/OR CHANGES IN THE {PortalName} WEB SITE AT ANY 
TIME. ADVICE RECEIVED VIA THE {PortalName} WEB SITE SHOULD NOT BE RELIED 
...
{PortalName} AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE 
...
{PortalName} WEB SITE FOR ANY PURPOSE. TO THE MAXIMUM EXTENT PERMITTED BY 
...
{PortalName} AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL WARRANTIES AND 
...
{PortalName} AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT, 
...
{PortalName} WEB SITE, WITH THE DELAY OR INABILITY TO USE THE 
{PortalName} WEB SITE OR RELATED SERVICES, THE PROVISION OF OR FAILURE TO 
PROVIDE SERVICES, OR FOR ANY INFORMATION, SOFTWARE, PRODUCTS, SERVICES AND 
RELATED GRAPHICS OBTAINED THROUGH THE {PortalName} WEB SITE, OR OTHERWISE 
ARISING OUT OF THE USE OF THE {PortalName} WEB SITE, WHETHER BASED ON 
CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF 
{PortalName} OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY 
...
THE {PortalName} WEB SITE, OR WITH ANY OF THESE TERMS OF USE, YOUR SOLE 
AND EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE {PortalName} WEB SITE.<br><br> 
SERVICE CONTACT : {AdministratorEmail}<br><br>
<span class="SubHead">TERMINATION/ACCESS RESTRICTION</span><br><br>
{PortalName} reserves the right, in its sole discretion, to terminate your 
access to the {PortalName} Web Site and the related services or 
...
of or relating to the use of the {PortalName} Web Site. Use of the 
{PortalName} Web Site is unauthorized in any jurisdiction that does not 
...
employment, or agency relationship exists between you and {PortalName} as 
a result of this agreement or use of the {PortalName} Web Site. 
{PortalName}’s performance of this agreement is subject to existing laws 
and legal process, and nothing contained in this agreement is in derogation of 
{PortalName}’s right to comply with governmental, court and law 
enforcement requests or requirements relating to your use of the 
{PortalName} Web Site or information provided to or gathered by 
{PortalName} with respect to such use. If any part of this agreement is 
...
constitutes the entire agreement between the user and {PortalName} with 
respect to the {PortalName} Web Site and it supersedes all prior or 
contemporaneous communications and proposals, whether electronic, oral or 
written, between the user and {PortalName} with respect to the 
{PortalName} Web Site. A printed version of this agreement and of any 
...
All contents of the {PortalName} Web Site are: 
Copyright © {Year} {PortalName} and/or its suppliers. All rights reserved.<br><br>
