...
Namespace THTT
    Public Class ThongKeLinhVucPhuong
...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents txtMaPhuong As System.Web.UI.WebControls.TextBox
...
#End Region
        ...
        Private Sub LoadGrid()
            Try
                ...
                Dim ds As DataSet
                'HieuLC3  10-11-2011 Lay Thong tin phong ban cua nguoi dang nhap
                ...
                objThongKeBaoCao.MaPhuong = txtMaPhuong.Text
                ds = objThongKe.ThongKeLinhVucPhuong(objThongKeBaoCao)
        ...
        Private Sub BindCombo()
            Dim objThongKeBaoCao As New ThongKeBaoCaoInfo
            objThongKeBaoCao.NguoiXemBaoCao = CType(Session.Item("UserName"), String)
            Dim paramValues As Object() = {objThongKeBaoCao.NguoiXemBaoCao}
            BindControl.BindDropDownList_StoreProc(ddlMaPhuong, True, "", "sp_GetDMPhuongByDieuKien", paramValues)
            If ddlMaPhuong.Items.Count > 0 And ddlMaPhuong.Items.Count = 1 Then
                ddlMaPhuong.SelectedIndex = 0
            End If
        End Sub
        ...
        Private Sub ddlMaPhuong_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlMaPhuong.SelectedIndexChanged
            txtMaPhuong.Text = ddlMaPhuong.SelectedItem.Value.ToString
        End Sub
    End Class
End Namespace