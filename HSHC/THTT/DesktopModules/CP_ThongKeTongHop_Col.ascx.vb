...
Namespace THTT
    Public Class CP_ThongKeTongHop_Col
...
#End Region
        ...
        Private Sub LoadContent()
            ...
            With xw
                For i = 0 To dv.Count - 1
                    ...
                    .WriteAttributeString("value", CType(dv.Item(i).Item(3), String))
        ...
        Protected Function GetURL(ByVal LinhVuc As String) As String
            ...
            strURL = "default.aspx?ctl=" & "DTH_COL" & "&SelectID=" & Request.Params("SelectID") & "&LinhVuc=" & LinhVuc & "&mid=" & Session("MidOfStartPage").ToString
