<%@ Control Language="vb" AutoEventWireup="false" Codebehind="VPHC_ChiTietVPHC_Col.ascx.vb" Inherits="THTT.VPHC_ChiTietVPHC_Col" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
	...
	<TR>
		<TD colSpan="6" align="center">
			<OBJECT id="ColumnF" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0"
				...
				<PARAM NAME="Movie" VALUE="xml/Column.swf?IsLocal=1&amp;dataURL=xml/<%=prefile%>_VPHC_ChiTietVPHC.xml">
				<PARAM NAME="Src" VALUE="xml/Column.swf?IsLocal=1&amp;dataURL=xml/<%=prefile%>_VPHC_ChiTietVPHC.xml">
