...
#End Region
        ...
        Private Sub Init_State()
            ...
            Select Case UCase(CStr(Request.Params("Loai")))
                ...
                'Case "TRUOCHAN" : lblLoai.Text = "DANH SÁCH HỒ SƠ TRẢ TRƯỚC HẠN"
        ...
        Private Sub LoadGrid()
            ...
            'Select Case UCase(CStr(Request.Params("Loai")))
            '    Case "TONTRUOC", "DAHUY", "CHUAGQTRONGHAN", "CHUAGQQUAHAN", "BOTUCHOSO" : BindControl.BindGrdHoSo(ds, dgdDanhSach, False, "Số biên nhận", "130,300,600,100,100,400", False, True)
            '    Case "MOINHAN", "DAGQDUNGHAN", "DAGQQUAHAN", "DATRA", "CHUATRA" : BindControl.BindGrdHoSo(ds, dgdDanhSach, False, "Số biên nhận", "130,300,600,100,100,100,300", False, True)
            'End Select
            'ds = Nothing
            ...
            Select Case UCase(CStr(Request.Params("Loai")))
                Case "TONGNHAN", "THUBAY", "TRUOCHAN", "DUNGHAN", "TREHEN", "DANGGIAIQUYET" : BindControl.BindGrdHoSo(ds, dgdDanhSach, False, "Số biên nhận", "130,300,600,100,100", False, True)
                    ...
                    'Case "MOINHAN", "DAGQDUNGHAN", "DATRA", "CHUATRA", "TRUOCHAN" : BindControl.BindGrdHoSo(ds, dgdDanhSach, False, "Số biên nhận", "130,300,600,100,100,100,300", False, True)
