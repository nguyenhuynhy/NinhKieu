...
#End Region
        ...
        Private Sub LoadContent()
            ...
            xw1.WriteAttributeString("yaxisname", "")
            xw1.WriteAttributeString("xaxisname", "")
            xw1.WriteAttributeString("showgridbg", "1")
            xw1.WriteAttributeString("canvasbgcolor", "FFC700")
            xw1.WriteAttributeString("gridbgcolor", "FFECAA")
            xw1.WriteAttributeString("hovercapbg", "FFECAA")
            xw1.WriteAttributeString("hovercapborder", "F47E00")
            xw1.WriteAttributeString("divlinecolor", "F47E00")
            With xw1
                'dung han
                .WriteStartElement("set")
