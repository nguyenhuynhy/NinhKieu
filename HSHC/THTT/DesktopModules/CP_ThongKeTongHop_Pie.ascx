<%@ Control Language="vb" AutoEventWireup="false" Codebehind="CP_ThongKeTongHop_Pie.ascx.vb" Inherits="THTT.CP_ThongKeTongHop_Pie" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
	...
	<TR>
		<TD colSpan="6" align="center">
			<OBJECT id="Pie3D" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0"
				...
				<PARAM NAME="Movie" VALUE="xml/Pie3D.swf?IsLocal=1&amp;dataURL=xml/<%=prefile%>_TongHopHoSo.xml">
				<PARAM NAME="Src" VALUE="xml/Pie3D.swf?IsLocal=1&amp;dataURL=xml/<%=prefile%>_TongHopHoSo.xml">
