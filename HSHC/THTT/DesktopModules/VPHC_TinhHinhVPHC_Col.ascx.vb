...
Namespace THTT
    Public Class VPHC_TinhHinhVPHC_Col
...
#End Region
        ...
        Private Sub LoadContent()
            ...
            xw.WriteAttributeString("yaxisname", "")
            xw.WriteAttributeString("xaxisname", "")
            xw.WriteAttributeString("showgridbg", "1")
            xw.WriteAttributeString("canvasbgcolor", "FFC700")
            xw.WriteAttributeString("gridbgcolor", "FFECAA")
            xw.WriteAttributeString("hovercapbg", "FFECAA")
            xw.WriteAttributeString("hovercapborder", "F47E00")
            xw.WriteAttributeString("divlinecolor", "F47E00")
            '-----------------------------------
            ...
            With xw
                For i = 0 To dv.Count - 1
                    ...
                    '    Case 1 : .WriteAttributeString("name", "Xay dung") 'name
                    '    Case 2 : .WriteAttributeString("name", "Van hoa") 'name
                    '    Case 3 : .WriteAttributeString("name", "Lao dong") 'name
                    'End Select
                    .WriteAttributeString("name", CType(dv.Item(i).Item(0), String)) 'name
                    .WriteAttributeString("value", CType(dv.Item(i).Item(2), String))
                    .WriteAttributeString("color", arrColor(i))
                    .WriteAttributeString("link", GetURL(CType(dv.Item(i).Item(0), String)))
                    .WriteEndElement() 'set
                Next
            End With
        ...
        Protected Function GetURL(ByVal pLinhVuc As String) As String
            ...
            strURL = "default.aspx?ctl=" & "VPTH_COL" & "&LinhVuc=" & pLinhVuc & "&SelectID=" & Request.Params("SelectID") & "&mid=" & Session("MidOfStartPage").ToString
