...
Namespace THTT
    Public Class ThongKeLoaiHoSoPhuong
...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents txtNguoiXemBaoCao As System.Web.UI.WebControls.TextBox
        Protected WithEvents lbMaPhuong As System.Web.UI.WebControls.Label
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                If Not Page.IsPostBack Then
                    If (DataCache.GetCache("ThongKeLoaiHoSoPhuong") Is Nothing) Then
                        DataCache.SetCache("ThongKeLoaiHoSoPhuong", Request.UrlReferrer.PathAndQuery)
                    End If
        ...
        Private Sub LoadGrid()
            ...
            objThongKeBaoCao.MaPhuong = CStr(Request.Params("MaPhuong"))
            'HieuLc3 11/11/2011 Thong ke tong hop Phuong
            objThongKeBaoCao.NguoiXemBaoCao = CType(Session.Item("UserName"), String)
            'End HieuLC3
            ds = objThongKe.ThongKeLoaiHoSoPhuong(objThongKeBaoCao)
        ...
        Private Sub dgdDanhSach_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgdDanhSach.PreRender
            ...
            'dgitem.Cells.Add(InitCell("Số hồ sơ 1 cửa tiếp nhận trong kỳ", 1, 2))
            'dgitem.Cells.Add(InitCell("Hủy trong kỳ", 1, 2))
            'dgitem.Cells.Add(InitCell("Đang chờ bổ sung hồ sơ", 1, 2))
            'dgitem.Cells.Add(InitCell("Còn lại", 1, 2))
            'dgitem.Cells.Add(InitCell("Phòng chuyên môn đã xử lý", 2, 1))
            'dgitem.Cells.Add(InitCell("Phòng chuyên môn chưa giải quyết", 2, 1))
            ...
            dgitem.Cells.Add(InitCell("Tên Loại Hồ Sơ", 1, 3)) 'Tên lĩnh vực
        ...
        Private Sub btnTroVe_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTroVe.Click
            ...
            Dim m_ReturnURL As String = CStr(DataCache.GetCache("ThongKeLoaiHoSoPhuong"))
            DataCache.RemoveCache("ThongKeLoaiHoSoPhuong")
