...
Namespace THTT
    ...
    Public Class MenuListController
        ...
        Public Function getMenuHoSo(ByVal objMenuListInfo As MenuListInfo, ByVal pItemCode As String) As DataSet
            Return DataProvider.Instance().ExecuteQueryStoreProc("sp_getMenuHoSo", objMenuListInfo.TabID, objMenuListInfo.UserID, pItemCode)
        End Function
        ...
        Public Function getDanhMucList(ByVal objMenuListInfo As MenuListInfo, ByVal UserID As String) As DataSet
            Return DataProvider.Instance().ExecuteQueryStoreProc("sp_getDanhMucList1", objMenuListInfo.TabID, UserID)
        End Function
