...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchHoSoXayDung.ascx.vb" Inherits=".SearchHoSoXayDung" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
...
<TABLE class="QH_Table" id="Table1" cellSpacing="0" cellPadding="0" width="100%">
	...
	<TR>
		<TD class="QH_ColLabel" width="15%" height="22">Địa chỉ thường trú</TD>
		<TD class="QH_ColControl" width="35%" height="22"><asp:textbox id="txtDiaChiThuongTru" Runat="server" Width="90%" CssClass="QH_TextBox"></asp:textbox></TD>
		<TD class="QH_ColLabel" width="15%" height="22">Số Tờ</TD>
		<TD class="QH_ColControl" width="35%" height="22"><asp:textbox id="txtSoTo" runat="server" Width="90%" CssClass="QH_TextBox"></asp:textbox></TD>
	</TR>
	<TR>
		<TD class="QH_ColLabel" width="15%" height="22">Số biên nhận</TD>
		<TD class="QH_ColControl" width="35%" height="22"><asp:textbox id="txtSoBienNhan" Runat="server" Width="90%" CssClass="QH_TextBox"></asp:textbox></TD>
		<TD class="QH_ColLabel" width="15%" height="22">Số Thửa</TD>
		<TD class="QH_ColControl" width="35%" height="22">
			<asp:textbox id="txtSoThua" runat="server" CssClass="QH_TextBox" Width="90%"></asp:textbox></TD>
	</TR>
	<tr>
		<td colSpan="4">&nbsp;
			<asp:textbox id="txtSoCMND" runat="server" CssClass="QH_TextBox" Width="0px"></asp:textbox></td>
	</tr>
	<tr>
		<td colSpan="4">
