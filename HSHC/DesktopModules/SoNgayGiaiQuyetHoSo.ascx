<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SoNgayGiaiQuyetHoSo.ascx.vb" Inherits="PortalQH.SoNgayGiaiQuyetHoSo" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
							...
							<TR>
								<TD height="172">
									<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<TD vAlign="top" width="20%" height="14"><asp:label id="Label3" Runat="server" CssClass="QH_LabelLeftBold">Mã loại hồ sơ</asp:label></TD>
											<td vAlign="top" colSpan="3" height="14"><asp:dropdownlist id="ddlMaLoaiHoSo" CssClass="QH_Dropdownlist" AutoPostBack="True" runat="server"
										...
										<tr>
											<TD vAlign="top" width="20%" height="14"><asp:label id="Label4" Runat="server" CssClass="QH_LabelLeftBold">Tình trạng kế tiếp</asp:label></TD>
											<td vAlign="top" colSpan="3" height="14"><asp:dropdownlist id="ddlMaTinhTrangNext" CssClass="QH_Dropdownlist" AutoPostBack="True" runat="server"
													Width="50%"></asp:dropdownlist></td>
										</tr>
										<tr>
											<td height="2"></td>
										...
										<tr>
											<TD vAlign="top"><asp:label id="Label1" Runat="server" CssClass="QH_LabelLeftBold">Số ngày giải quyết</asp:label></TD>
											<td vAlign="top" colSpan="3"><asp:TextBox ID="txtSoNgayGiaiQuyet" Runat="server" CssClass="QH_TextRight" MaxLength="3" Width="50px"></asp:TextBox></td>
										</tr>
										<tr>
											<td height="2"></td>
										</tr>
