...
Public Class SearchChiTietHoSo
...
#End Region
    ...
    Private Sub LoadGrid()
        ...
        If Not ds Is Nothing Then
            If Not ds.Tables(0).Rows.Count = 0 Then
                ...
                'BindControl.BindDataGrid(ds, dgdHistory, True, False, False, "STT", "", "", "", 50, 400, 400, 100)
                dgdHistory.DataSource = ds
                dgdHistory.DataBind()
            End If
        End If
        ...
        If dgdHistory.Visible = True Then
            ...
            ds = DataProvider.Instance.ExecuteQueryStoreProc(DBName & "..sp_ChiTietHoSoHistory", "FSSPORTALQH", Request("ID"), Request("SoGiayPhep"))
    ...
    Private Sub CreateControls()
        ...
        arr = GetDieuKien()
        ds = objSearchInfo.GetThongTinTimKiem_ChiTiet(DBName, _
                                    arr)
