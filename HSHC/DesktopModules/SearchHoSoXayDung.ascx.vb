...
Public Class SearchHoSoXayDung
...
#End Region
    ...
    Private Sub LoadGrid()
        ...
        ds = objSearchInfo.GetThongTinTimKiemXayDung(ConfigurationSettings.AppSettings("commonDB"), txtTuNgay.Text, txtDenNgay.Text, txtSoGiayPhep.Text.Trim(), txtHoTen.Text.Trim, txtDiaChiThuongTru.Text.Trim, txtSoTo.Text.Trim, txtSoThua.Text.Trim, txtSoNha.Text.Trim, ddlDuong.SelectedValue, ddlPhuong.SelectedValue, txtSoBienNhan.Text.Trim, ddlLoaiHoSo.SelectedValue, strURL)
