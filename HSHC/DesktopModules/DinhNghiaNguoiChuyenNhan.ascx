<%@ Control Language="vb" AutoEventWireup="false" Codebehind="DinhNghiaNguoiChuyenNhan.ascx.vb" Inherits="PortalQH.DinhNghiaNguoiChuyenNhan" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
							...
							<TR>
								<TD height="172">
									<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<TD class="QH_LabelLeftBold" width="10%">Vai trò
											</TD>
											<td><asp:CheckBox CssClass="QH_LoaiHS" Width="200px" id="chkNguoiChuyen" runat="server" Text="Người chuyển"
													AutoPostBack="True"></asp:CheckBox>
												<asp:CheckBox CssClass="QH_LoaiHS" Width="200px" id="chkNguoiNhan" runat="server" Text="Người nhận"
