<%@ Control Language="vb" AutoEventWireup="false" Codebehind="TabLoaiHoSoMotCua.ascx.vb" Inherits="PortalQH.TabLoaiHoSoMotCua" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
