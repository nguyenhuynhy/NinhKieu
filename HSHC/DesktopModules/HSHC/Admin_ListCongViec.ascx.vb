...
Namespace HSHC
    Public Class Admin_ListCongViec
...
#End Region
        ...
        Private Sub BindGrid()
            Dim objcon As New DanhSachCongViecController
            Dim ds As DataSet
            Dim strURL As String
            strURL = EditURL("ID", "value", "EditCongViec")
            ds = objcon.CongViec_List(ConfigurationSettings.AppSettings("db_web").ToString(), strURL)
        ...
        Private Sub btnXoa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnXoa.Click
            ...
            For i = 0 To dgdDanhSach.Items.Count - 1
                ...
                If chkXoa.Checked Then
                    objcon.CongViec_Del(ConfigurationSettings.AppSettings("db_web").ToString(), CType(Me.dgdDanhSach.Items(i).FindControl("morelink"), HyperLink).Text)
                End If
            Next
            BindGrid()
            objcon = Nothing
        ...
        Private Sub btnThemMoi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnThemMoi.Click
            Response.Redirect(EditURL("ID", "", "EditCongViec"))
        End Sub
    End Class
