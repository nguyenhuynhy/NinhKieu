<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_AddParam.ascx.vb" Inherits="HSHC.Admin_AddParam" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
