<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_AddNhom.ascx.vb" Inherits="HSHC.Admin_AddNhom" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
										...
										<TR>
											<TD height="313" valign="top">
												<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<TR>
														<TD align="center">
															<asp:Label height="18" id="lblTitle1" Class="QH_DataGridHeader" Width="90%" runat="server">Chọn thành viên cho nhóm</asp:Label></TD>
													</TR>
													<TR>
														<TD align="center">
															<asp:CheckBoxList class="QH_Textbox" Width="90%" id="cklThanhvien" runat="server" RepeatColumns="3"></asp:CheckBoxList></TD>
													</TR>
													<tr>
														<td height="5">
														</td>
