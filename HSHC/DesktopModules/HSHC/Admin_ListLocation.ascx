<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_ListLocation.ascx.vb" Inherits="HSHC.Admin_ListLocation" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
<!--Start bound-->
