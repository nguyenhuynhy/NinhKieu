<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_AddCongViec.ascx.vb" Inherits="HSHC.Admin_AddCongViec" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
														...
														<TD>
															<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<TR>
																	...
																	<TD>
																		<asp:TextBox id="txtCongViecID" Width="25%" CssClass="QH_Textbox" runat="server"></asp:TextBox></TD>
																</TR>
																<TR>
																	<TD class="QH_ColLabel" width="200">
																		Công việc</TD>
																	<TD>
																		<asp:TextBox id="txtCongViec" Width="50%" CssClass="QH_Textbox" runat="server"></asp:TextBox></TD>
																</TR>
															</TABLE>
														</TD>
													</TR>
