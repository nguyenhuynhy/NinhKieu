...
#End Region
        ...
        Private Sub BindGrid()
            ...
            strURL = EditURL("ID", "value", "EditNhom")
            ds = objcon.Nhom_List(ConfigurationSettings.AppSettings("db_web").ToString(), strURL)
        ...
        Private Sub btnXoa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnXoa.Click
            ...
            For i = 0 To dgdDanhSach.Items.Count - 1
                ...
                If chkXoa.Checked Then
                    objcon.Nhom_Del(ConfigurationSettings.AppSettings("db_web").ToString(), CType(Me.dgdDanhSach.Items(i).FindControl("morelink"), HyperLink).Text)
                End If
            Next
            BindGrid()
            objcon = Nothing
        ...
        Private Sub btnThemMoi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnThemMoi.Click
            Response.Redirect(EditURL("ID", "", "EditNhom"))
        End Sub
    End Class
End Namespace
