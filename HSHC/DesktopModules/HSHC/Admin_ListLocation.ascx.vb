...
Namespace HSHC
    Public Class Admin_ListLocation
...
#End Region
        ...
        Private Sub BindGrid()
            ...
            strURL = EditURL("ID", "value", "EditLocation")
            ds = objcon.DiaDiem_List(ConfigurationSettings.AppSettings("db_web").ToString(), strURL)
        ...
        Private Sub btnXoa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnXoa.Click
            ...
            For i = 0 To dgdDanhSach.Items.Count - 1
                ...
                If chkXoa.Checked Then
                    objcon.DiaDiem_Del(ConfigurationSettings.AppSettings("db_web").ToString(), CType(Me.dgdDanhSach.Items(i).FindControl("morelink"), HyperLink).Text)
                End If
            Next
            BindGrid()
            objcon = Nothing
        ...
        Private Sub btnThemMoi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnThemMoi.Click
            Response.Redirect(EditURL("ID", "", "EditLocation"))
        End Sub
    End Class
