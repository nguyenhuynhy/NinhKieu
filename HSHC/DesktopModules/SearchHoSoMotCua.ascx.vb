...
#End Region
    ...
    Private Sub LoadGrid()
        ...
        ds = objSearchInfo.GetThongTinTimKiemMotCua(ConfigurationSettings.AppSettings("commonDB"), txtTuNgay.Text, txtDenNgay.Text, txtSoNha.Text.Trim(), txtHoTen.Text.Trim, ddlDuong.SelectedValue, ddlLoaiHoSo.SelectedValue, ddlPhuong.SelectedValue, mLinhVuc, txtSoBienNhan.Text.Trim, strURL)
