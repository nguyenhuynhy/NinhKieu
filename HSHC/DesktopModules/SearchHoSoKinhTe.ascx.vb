...
#End Region
    ...
    Private Sub LoadGrid()
        ...
        ds = objSearchInfo.GetThongTinTimKiemKinhTe(ConfigurationSettings.AppSettings("commonDB"), txtTuNgay.Text, txtDenNgay.Text, txtSoGiayPhep.Text.Trim(), txtHoTen.Text.Trim, txtSoCMND.Text.Trim, txtSoNha.Text.Trim, ddlDuong.SelectedValue, ddlPhuong.SelectedValue, txtSoBienNhan.Text.Trim, ddlLoaiHoSo.SelectedValue, strURL)
