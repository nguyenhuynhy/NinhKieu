<%@ Control Language="vb" AutoEventWireup="false" Codebehind="DanhSachHoSo.ascx.vb" Inherits="CPVHQH.DanhSachHoSo" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
<%@ Register TagPrefix="uc1" TagName="ThongTinTraCuuVH" Src="ThongTinTraCuuVH.ascx" %>
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD align="center">
										...
										<TR>
											<TD vAlign="top" width="100%">
												<TABLE class="QH_LoaiHS" id="tblHeader" width="100%" align="center" runat="server">
													<TR vAlign="middle">
														<TD vAlign="middle" align="right" width="20%" height="50"><STRONG> Loại hồ sơ tiếp 
																nhận&nbsp;</STRONG>
														</TD>
													...
													<TR>
														<TD>
															<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%" border="0">
																...
																<TR>
																	<TD><uc1:thongtintracuuvh id="ThongTinTraCuuVH1" runat="server"></uc1:thongtintracuuvh></TD>
																</TR>
																<TR>
																	<TD height="5">
																...
																<TR>
																	<TD>
																		<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
																			<TR>
																				<TD align="center" width="100%" height="16"><asp:linkbutton id="btnTimKiem" runat="server" CssClass="QH_Button">Tìm kiếm</asp:linkbutton>&nbsp;
									...
									<asp:TextBox id="txtChuoiSoBienNhan" Width="0%" runat="server"></asp:TextBox>
								</TD>
							</TR>
						</TABLE>
					</td>
