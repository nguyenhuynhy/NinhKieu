...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Select Case Request.Params("Loai")
                Case "DX"
                    ...
                    btnInPhieuChuyen.Visible = False
            ...
            'txtNgayPhanHoiThucTe.Attributes.Add("onblur", "javascript:CheckDateOnBlur(" & Replace(Me.UniqueID, ":", "_") & "_txtNgayPhanHoiThucTe);")
            'imgNgayPhanHoiThucTe.Attributes.Add("onclick", "javascript:popUpCalendar(this," & Replace(Me.UniqueID, ":", "_") & "_txtNgayPhanHoiThucTe, 'dd/mm/yyyy');")
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            If Request.Params("Loai") = "TD" Then
            End If
        End Sub
