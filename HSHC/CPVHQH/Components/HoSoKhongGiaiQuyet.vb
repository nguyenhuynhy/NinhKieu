...
Namespace CPVHQH
    ...
    Public Class HoSoKhongGiaiQuyetController
        ...
        End Function
        Public Function InHoSoKhongGiaiQuyet(ByVal strHoSoKhongGiaiQuyetID As String) As DataSet
            Return DataProvider.Instance.ExecuteQueryStoreProc("sp_InThongBaoHoSoKhongGiaiQuyet", strHoSoKhongGiaiQuyetID)
        End Function
