...
Namespace CPVHQH
    <Serializable()> Public Class ThongTinTraCuuVHInfo
    ...
    Public Class ThongTinTraCuuVHController
        Public Function GetInfoFromSearchCD0(ByVal objTTTCInfo As ThongTinTraCuuVHInfo) As DataSet
            Return DataProvider.Instance.ExecuteQueryStoreProc("sp_GetDanhSachHoSoCD0", _
                                                            ...
                                                            objTTTCInfo.LoaiHoSo, objTTTCInfo.TinhTrang, _
                                                             objTTTCInfo.URL)
        End Function
        Public Function GetInfoFromSearchCD1(ByVal objTTTCInfo As ThongTinTraCuuVHInfo) As DataSet
            Return DataProvider.Instance.ExecuteQueryStoreProc("sp_GetDanhSachHoSoCD1", _
                                                            ...
                                                            objTTTCInfo.LoaiHoSo, objTTTCInfo.TinhTrang, _
                                                             objTTTCInfo.URL)
        End Function
        Public Function GetDanhSachCongVan(ByVal objTTTCInfo As ThongTinTraCuuVHInfo) As DataSet
        ...
        End Function
        Public Function GetInfoFromSearch(ByVal objTTTCInfo As ThongTinTraCuuVHInfo) As DataSet
        ...
        Public Function GetInfoFromSearch1(ByVal objTTTCInfo As ThongTinTraCuuVHInfo) As DataSet
