...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TimKiemDoanhNghiep.aspx.vb" Inherits="CPLDQH.TimKiemDoanhNghiep" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>DANH SACH DOANH NGHIEP</title>
		<link 
...
src='<%= Request.ApplicationPath + "/Inc/popcalendar.js"%>'></script>
			<script language="javascript">
				function form1_onsubmit()
				{
					...
					{
						if (window.opener.document.forms(0).item(i).id.indexOf('txtSuDungLaoDongID') != -1)
						{		
					...
					{
						if (window.document.forms(0).item(i).id.indexOf('txtSuDungLaoDongIDChon') != -1)
						{
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td class="QH_Khung_TopMid" width="*">&nbsp;
									<asp:label id="Label3" runat="server" Width="100%" CssClass="QH_Label_Title">Tìm kiếm Doanh nghiệp</asp:label></td>
										...
										<TR>
											<TD align="center" width="100%">
												<TABLE class="QH_Table" id="Table2" cellSpacing="0" cellPadding="0" width="90%" align="center"
													border="0">
													<TR>
														<TD class="QH_ColLabel" width="15%">Tên đơn vị</TD>
														<TD class="QH_ColControl" width="35%"><asp:textbox id="txtHoTen" runat="server" Width="80%" CssClass="QH_Textbox"></asp:textbox><asp:textbox id="txtSuDungLaoDongIDChon" Width="0px" CssClass="QH_TextBox" Runat="server"></asp:textbox></TD>
														<TD class="QH_ColLabel" width="15%">Tên chủ đơn vị</TD>
														<TD class="QH_ColControl" width="35%"><asp:textbox id="txtTenChuDonVi" runat="server" Width="80%" CssClass="QH_Textbox"></asp:textbox></TD>
													</TR>
													<tr>
														<TD class="QH_ColLabel" width="15%">Số nhà</TD>
														<TD class="QH_ColControl" width="35%"><asp:textbox id="txtSoNha" Width="80%" CssClass="QH_TextBox" Runat="server"></asp:textbox></TD>
