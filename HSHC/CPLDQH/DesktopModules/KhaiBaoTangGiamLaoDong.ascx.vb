...
Namespace CPLDQH
    ...
    '=Người tạo : TuanNH                                     =
    '=Ngày tạo  : 12/04/2006                                 =
    '=Mục đích  : thụ lý hồ sơ khai báo tăng giảm lao động   =
    '=========================================================

    Public Class KhaiBaoTangGiamLaoDong
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not Me.IsPostBack Then
                ...
                If Trim(txtBienDongLaoDongID.Text) <> "" Then 'Da co data
        ...
        Private Sub loadDataToControl()
            ...
            If CType(Request.QueryString("ctl"), String) = "TANGGIAMLAODONG" Then
                If Not Request.QueryString("ID") Is Nothing Then
                    txtHoSoTiepNhanID.Text = CType(Request.QueryString("ID"), String)
                End If
                ds = objSuDungLaoDong.GetBienDongLaoDong(txtHoSoTiepNhanID.Text)
            End If
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            End If
            Dim objSuDungLaoDong As New SuDungLaoDongController
            txtSuDungLaoDongID.Text = objSuDungLaoDong.AddBienDongLaoDong(Me)   'Thêm mới khai báo tăng giảm
            objSuDungLaoDong = Nothing
        ...
        Private Sub btnXoa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnXoa.Click
            Dim objSuDungLaoDong As New SuDungLaoDongController
            objSuDungLaoDong.DelBienDongLaoDong(Me) 'Xóa khai báo tăng giảm lao động
            objSuDungLaoDong = Nothing
