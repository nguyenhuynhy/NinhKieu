<%@ Control Language="vb" AutoEventWireup="false" Codebehind="HoSoKhong.ascx.vb" Inherits="CPLDQH.HoSoKhong" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
		...
		<TD width="100%" height="24">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="QH_Khung_TopMid" width="*"><asp:label id="lblHeader" CssClass="QH_Label_Title" Width="100%" runat="server">Thông tin không giải quyết hồ sơ cấp phép lao động</asp:label>
					</td>
