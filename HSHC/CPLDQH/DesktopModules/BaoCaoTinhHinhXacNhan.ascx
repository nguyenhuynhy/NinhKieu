...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="BaoCaoTinhHinhXacNhan.ascx.vb" Inherits="CPLDQH.BaoCaoTinhHinhXacNhan" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
									...
									<TABLE class="QH_LoaiHS" id="tblHeader" width="100%" align="center" runat="server">
										...
										<TR>
											<TD vAlign="top" width="100%" colSpan="3">
												<asp:radiobuttonlist id="lstReports" Width="100%" runat="server" AutoPostBack="True" RepeatColumns="2"></asp:radiobuttonlist></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
