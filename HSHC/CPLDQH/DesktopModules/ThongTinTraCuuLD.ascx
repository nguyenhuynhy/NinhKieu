...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongTinTraCuuLD.ascx.vb" Inherits="CPLDQH.ThongTinTraCuuLD" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
...
<TABLE class="QH_Table" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<TR>
		...
		<TD class="QH_ColControl"><asp:textbox id="txtNgayCongVan" CssClass="QH_TextBox" Width="40%" Runat="server" MaxLength="10"></asp:textbox>
			<asp:HyperLink id="cmdNgayCongVan" CssClass="commnadbutton" runat="server">
