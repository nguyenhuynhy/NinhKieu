...
'---------------------Global Constants and Variables---------------------
	...
	Session.codepage = 65001	
	Const CONNECTION_STRING_HSHC = "driver={SQL SERVER};Server=xxxDBSERVERxxx;Database=FSSHSHCQH;UID=xxxUSERIDxxx;PWD=xxxPASSWORDxxx;" 'Trung tam thong tin
	Const CONNECTION_STRING_CPKT = "driver={SQL SERVER};Server=xxxDBSERVERxxx;Database=FSSCPKTQH;UID=xxxUSERIDxxx;PWD=xxxPASSWORDxxx;"
	Const CONNECTION_STRING_CPVH = "driver={SQL SERVER};Server=xxxDBSERVERxxx;Database=FSSCPVHQH;UID=xxxUSERIDxxx;PWD=xxxPASSWORDxxx;"
	Const CONNECTION_STRING_CPLD = "driver={SQL SERVER};Server=xxxDBSERVERxxx;Database=FSSCPLDQH;UID=xxxUSERIDxxx;PWD=xxxPASSWORDxxx;"
