...
'---------------------Global Constants and Variables---------------------
	...
	'Const CONNECTION_STRING_HSHC = "driver={SQL SERVER};Server=phuocdd;Database=FSSHSHCQH;UID=sa;PWD=sa;" 'Trung tam thong tin
	'Const CONNECTION_STRING_CPKT = "driver={SQL SERVER};Server=phuocdd;Database=FSSCPKTQH;UID=sa;PWD=sa;"
	'Const CONNECTION_STRING_CPVH = "driver={SQL SERVER};Server=phuocdd;Database=FSSCPVHQH;UID=sa;PWD=sa;"
	'Const CONNECTION_STRING_CPLD = "driver={SQL SERVER};Server=phuocdd;Database=FSSCPLDQH;UID=sa;PWD=sa;"	
	
	Const CONNECTION_STRING_HSHC = "driver={SQL SERVER};Server=phuocdd\sql2005;Database=FSSHSHCQH;UID=sa;PWD=p@ss;" 'Trung tam thong tin
	Const CONNECTION_STRING_CPKT = "driver={SQL SERVER};Server=phuocdd\sql2005;Database=FSSCPKTQH;UID=sa;PWD=p@ss;"
	Const CONNECTION_STRING_CPVH = "driver={SQL SERVER};Server=phuocdd\sql2005;Database=FSSCPVHQH;UID=sa;PWD=p@ss;"
	Const CONNECTION_STRING_CPLD = "driver={SQL SERVER};Server=phuocdd\sql2005;Database=FSSCPLDQH;UID=sa;PWD=p@ss;"	
...
sub Open(iReportname, iFormula, iFormulaValue)
	...
	'response.Write(session("oClientDoc").Open ("rassdk://" & path & iReportname))
	'response.end
