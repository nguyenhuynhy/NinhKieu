...
'---------------------Global Constants and Variables---------------------
	...
	Const CONNECTION_STRING = "driver={SQL SERVER};Server=xxxDBSERVERxxx;Database=FSSHSHCQH;UID=xxxUSERIDxxx;PWD=xxxPASSWORDxxx;" 'Trung tam thong tin
	
'	Const TenCongTy1 = "UY BAN HUYEN CU CHI"
'	Const TenCongTy2 = "VĂN PHÒNG HUYEN CU CHI"
