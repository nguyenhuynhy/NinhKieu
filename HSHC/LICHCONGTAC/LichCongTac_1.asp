...
<html>
	...
	<body text="#000000" topmargin="0" leftmargin="0" onload="javascript:StartUp();">
		...
		<table cellpadding="0" cellspacing="0" width="100%" height="100%" background="images/Lich_hom_nay_1.jpg">
	<!-- MSTableType="layout" -->
	<tr>
		<td width="30" align="center" valign="middle" rowspan="4">&nbsp;</td>
		<td height="30" width="740"></td>
		<td width="30" rowspan="4"></td>
	</tr>
	<tr>
		<td align="left" height="30" width="740">
	...
	<tr>
		<td height="510" width="740" align="center">
			<MARQUEE id="MARQUEE1" scrollAmount=<%=m_Delay%> scrollDelay="50" style="WIDTH: <%=Width-BannerLeft_Width-BannerRight_Width%>; HEIGHT: 500; TEXT-ALIGN: center;"
									direction="up">
									<%IF Not rs.eof then%>
										<%while not rs.eof%>
										<P>
