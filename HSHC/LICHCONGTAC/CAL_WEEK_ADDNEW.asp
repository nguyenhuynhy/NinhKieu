...
<script language="javascript">
	...
	{
		if (frm.cboChucTho.selectedIndex != 0){
			...
			frm.txtDuration.disabled = false
		}		
	}
	function Validate(){
...
<body background=Images/bg.gif topmargin=0 leftmargin=0 onLoad='javascript:ChangeType();'>
<center>
	    ...
	    <td width="100%">
			<table cellspacing="1" width="100%">
				<tr>
					...
					<td width=*" class="QH_LabelLeft"><%call MakeCbo("cboType","SELECT * FROM BOOKTYPES WHERE SHOW='1' ORDER BY STT",strType,"BookType_ID","BookType","250","0"," onchange='javascript:ChangeType();'")%>
					Nhóm công việc
					&nbsp;<%call MakeCbo("cboChucTho","SELECT * FROM CONGVIEC ORDER BY CONGVIECID",strCongViec,"CONGVIECID","CONGVIEC","90","1"," onclick='javascript:ChucThoChange();'")%>
					</td>
				</tr>
				<tr>
					<td class="QH_ColLabel" width="25%" align="right">Ngày họp</td>
					<td width=*" class="QH_LabelLeft"><input type="text" name="txtMeetingDate" size="13" class="QH_Textbox" value="<%=strBookDate%>" onblur="javascript:CheckNgayHop();">&nbsp;&nbsp;
					&nbsp;Giờ bắt đầu&nbsp;&nbsp;&nbsp;<%call MakeComboGio("cboHour",strGio)%>&nbsp;<%call MakeComboPhut("cboMinute",strPhut)%>
					&nbsp;&nbsp;&nbsp;&nbsp;Thời gian họp&nbsp;&nbsp;<input type="text" name="txtDuration" class="QH_Textbox" value="<%=strDuration%>" size="5" onblur="javascript:checknum(frm.txtDuration)">&nbsp;( phút )</td>
				</tr>
				<tr>
					<td class="QH_ColLabel" width="25%" valign="top" align="right">Nội dung <font size="2" color="red">(*)</font></td>
					<td width=*" class="QH_LabelLeft"><textarea class="QH_textbox" name="txtContent" rows="4" cols="81"><%=strContent%></textarea></td>
				</tr>
				<tr>
					<td class="QH_ColLabel" width="25%" align="right">
						<!--<a href="javascript:openNguoiChuTri();">-->Người chủ trì<!--</a>--></td>
					<td width=*" class="QH_LabelLeft"><%call MakeCbo("cboChairMan","COMM_GetChairMan",strChairManID,"UserID","FullName","244","1"," onchange='javascript:ChangeChairMan();'")%>
					<input type="checkbox" value="false" <%=chkNgoaiLich%> name="chkNgoaiLich">Ngoài lịch</td>
				</tr>
				<tr>
					<td class="QH_ColLabel" width="25%" align="right">Địa điểm</td>
					<td width=*" class="QH_LabelLeft"><%call MakeCbo("cboLocation","COMM_GetLocation",strLocationID,"ID","LocationName","244","0"," onchange='javascript:ChangeLocation();'")%>
					<input type="text" name="txtLocation" maxlength="1000" size="30" class="QH_Textbox"  value="<%=strLocation%>"></td>
				</tr>
				<tr>
					<td class="QH_ColLabel" width="25%" align="right"><a href="javascript:openMemberJoin();">Thành phần tham dự</a></td>
					<td width=*" class="QH_LabelLeft"><textarea name="txtMemberJoin" maxlength="1000" rows="4" Cols="81" class="QH_Textbox"><%=strMemberJoin%></Textarea></td>
				</tr>
				<tr>
					<td class="QH_ColLabel" width="25%" align="right">Chuẩn bị</td>
					<td width=*" class="QH_LabelLeft"><textarea name="txtNote" rows="4" cols="81" class="QH_Textbox"><%=strNote%></textarea></td>
				</tr>
				<tr>
					<td class="QH_ColLabel" width="25%" align="right"></font></td>
					<td width=*" class="QH_LabelLeft">
					<input type="hidden" name="txtStt" maxlength="2" size="15" class="QH_Textbox"  value="<%=strSTT%>" ID="Text1" readonly=yes>
				</tr>
				<!--<tr>
