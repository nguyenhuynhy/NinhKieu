<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_ListCongViec.ascx.vb" Inherits="LICHCONGTAC.Admin_ListCongViec" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
<!--Start bound-->
