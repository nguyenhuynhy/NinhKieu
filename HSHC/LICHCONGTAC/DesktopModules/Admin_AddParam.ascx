<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_AddParam.ascx.vb" Inherits="LICHCONGTAC.Admin_AddParam" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
			...
			<table width="100%" cellSpacing="0" cellPadding="0">
				<tr>
					...
					<td width="*" height="25" class="QH_Content_TopMid">
						<asp:label id="lblTitle" runat="server" width="100%" CssClass="QH_Content_Header_Middle">DANH SÁCH THỜI GIAN HỌP</asp:label>
					</td>
									...
									<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="80%" border="0">
													...
													<TR>
														<TD>
															<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<TR>
																	<TD class="QH_ColLabel" width="200">
																		Diễn giải</TD>
																	<TD>
																		<asp:TextBox id="txtDescription" Width="50%" CssClass="QH_Textbox" runat="server"></asp:TextBox></TD>
																</TR>
																<TR>
																	<TD class="QH_ColLabel" width="200">Thời gian</TD>
																	<TD>
																		<asp:TextBox id="txtParamValue" Width="20%" CssClass="QH_Textbox" runat="server"></asp:TextBox></TD>
																</TR>
															</TABLE>
														</TD>
													</TR>
										...
										<TR>
											<TD align="center"><asp:ImageButton id="btnCapNhat" runat="server" ImageUrl="../../Images/btn_CapNhat.gif" CssClass="QH_Button"></asp:ImageButton>
												...
												<asp:TextBox id="txtParamID" Width="0px" runat="server"></asp:TextBox>
											</TD>
										</TR>
									</TABLE>
								</TD>
