...
#End Region
        ...
        Private Sub BindGrid()
            ...
            strURL = EditURL("ID", "value", "EditParam")
            ds = objcon.ThoiGian_List(ConfigurationSettings.AppSettings("db_web").ToString(), strURL)
            BindControl.BindGrdHoSo(ds, dgdDanhSach, True, "", "0,600,100", False, True)
            AlignGrid()
            objcon = Nothing
            ds = Nothing
        End Sub
        Sub AlignGrid()
            dgdDanhSach.Columns(4).ItemStyle.HorizontalAlign = HorizontalAlign.Center
        End Sub
        ...
        Private Sub btnXoa_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnXoa.Click
            ...
            For i = 0 To dgdDanhSach.Items.Count - 1
                ...
                If chkXoa.Checked Then
                    objcon.ThoiGian_Del(ConfigurationSettings.AppSettings("db_web").ToString(), CType(Me.dgdDanhSach.Items(i).FindControl("morelink"), HyperLink).Text)
                End If
            Next
            BindGrid()
            objcon = Nothing
        ...
        Private Sub btnThemMoi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnThemMoi.Click
            Response.Redirect(EditURL("ID", "", "EditParam"))
        End Sub
    End Class
