<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_AddLocation.ascx.vb" Inherits="LICHCONGTAC.Admin_AddLocation" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
