<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_AddChucNang.ascx.vb" Inherits="LICHCONGTAC.Admin_AddChucNang" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
										...
										<TR>
											<TD height="313" valign="top">
												<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<TR>
														<TD align="center">
															<asp:Label height="18" id="lblTitle1" CssClass="QH_DataGridHeader" Width="90%" runat="server">CHỌN VAI TRÒ CHO CHỨC NĂNG</asp:Label></TD>
													</TR>
													<TR>
														<TD align="center">
															<asp:CheckBoxList Cssclass="QH_LoaiHS" Width="90%" id="cklVaiTro" runat="server" RepeatColumns="3"></asp:CheckBoxList></TD>
													</TR>
													<TR>
