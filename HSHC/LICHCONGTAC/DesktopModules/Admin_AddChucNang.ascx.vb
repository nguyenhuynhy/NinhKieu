...
#End Region
        ...
        Sub InitGrid()
            Dim objcon As New DanhSachChucNangController
            BindControl.BindCheckBoxList(cklVaiTro, ConfigurationSettings.AppSettings("db_web").ToString() & "..Web_LstDMROLE", "", ConfigurationSettings.AppSettings("commonDB").ToString())
            objcon = Nothing
        End Sub
        Sub SetCheckGrid()
            Dim objcon As New DanhSachChucNangController
