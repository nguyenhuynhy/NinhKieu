<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Admin_ListNhom.ascx.vb" Inherits="LICHCONGTAC.Admin_ListNhom" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
<!--Start bound-->
