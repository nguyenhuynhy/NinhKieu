...
#End Region
        ...
        Sub InitGrid()
            Dim objcon As New DanhSachNhomController
            BindControl.BindCheckBoxList(cklThanhvien, ConfigurationSettings.AppSettings("db_web").ToString() & "..Web_LstUser", "", ConfigurationSettings.AppSettings("commonDB").ToString())
            objcon = Nothing
        End Sub
        Sub SetCheckGrid()
            Dim i As Integer
