...
Namespace LICHCONGTAC
    Public Class Admin_AddCongViec
...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents txtCongViec As System.Web.UI.WebControls.TextBox
...
#End Region
        ...
        Sub InitState()
            ...
            If Not Request.Params("ID") Is Nothing Then
                ...
                txtCongViecID.ReadOnly = True
            End If
            ds = objcon.CongViec_Get(ConfigurationSettings.AppSettings("db_web").ToString(), ID)
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCapNhat.Click
            Dim objcon As New DanhSachCongViecController
            objcon.CongViec_Insert(ConfigurationSettings.AppSettings("db_web").ToString(), txtCongViecID.Text, txtCongViec.Text)
