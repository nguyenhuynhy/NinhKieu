...
<script language="javascript">
	...
	{		
		FileWindow = window.open('Comm_rptInLichTruc.asp?FromDay=' + strFromDay,null);
		FileWindow.focus();
	}
...
<center>
<form name="checkform" action="LichTruc_APPROVED.ASP" method="POST">
	...
	IF Not rs.eof then%>	
		<%while not rs.eof%>
			<tr>
				...
				<td class="QH_Label" align="center" valign="top"><%call ShowOneDay(DateValueVN(curDate),"S", strNguoiTrucID)%></td>				
				<td width="1" bgcolor="<%=ColorNgay%>"></td>
				<td class="QH_Label" align="center" valign="top"><%call ShowOneDay(DateValueVN(curDate),"T", strNguoiTrucID)%></td>
			</tr>
			<tr>
...
<%sub ShowToolBar()%>
	 <table cellpadding="0" cellspacing="2" width="100%">
		<tr valign="absmiddle">			
			<!--<td width="22%" class="QH_Label" valign="absmiddle"><a href="javascript:location.href='../Home.asp';" ><img alt="Tro ve trang chu" src="images/home.gif" border="0" align="absmiddle">&nbsp;Trang chủ</a></td>-->
			...
			<td width="30%" class="QH_Label" valign="absmiddle"><a href="javascript:inbaocao('<%=DateValueVN(WeekFrom)%>')" ><img alt="In lich lam viec" src="images/print.gif" border="0" align="absmiddle">&nbsp;In lịch</a></td>
			<!--<td width="25%" valign="absmiddle"><font class="title"><a href="CAL_WEEK_APPROVED.ASP" ><img alt="Xem lich chinh thuc" src="images/approved.gif" border="0" align="absmiddle">&nbsp;Lịch làm việc</a></font></td>-->
			<!--<td width="*" valign="absmiddle"><font class="title"><a href="Javascript:ViewOneDay();" ><img alt="Xem lich lam viec trong ngay" src="images/approved.gif" border="0" align="absmiddle">&nbsp;Lịch trong ngày</a></font></td>-->
			<td width="*">&nbsp;</td>
		</tr>
	</table>
<%END sub%>
