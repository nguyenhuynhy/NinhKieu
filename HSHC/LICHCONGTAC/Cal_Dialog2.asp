...
function fl_ColorNormal(Row, Col)	{
	...
	if (Col == 0) 
		...
		fl_tblCalendar.rows(Row).cells(Col).style.color = "003366"	
...
{  
  ...
  //window.opener.checkform.SelectDay.value = fnConvertDateVN_EN(fl_tdDate.innerText)
  //alert(fl_tdDate.innerText);
  sData.fnUpdate2();
  //window.opener.document.checkform.submit();
...
<TABLE id=fl_tblCalendar cellSpacing=1 cellPadding=1 width="100%" border=1 onclick="fl_tblCalendar_onclick()"  ondblclick = "fl_tblCalendar_ondblclick()">
  <tbody align=center>
  <TR  style="font-family: Arial;color:#003366;FONT-WEIGHT: bold">
    <TD></TD>
    <TD></TD>
    <TD></TD>
    <TD></TD>
    ...
    <TD></TD></TR>
  <TR>
    <TD style="font-family: Arial;color:red;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD></TR>
  <TR>
    <TD style="font-family: Arial;color:red;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD>
    <TD style="font-family: Arial;color:#003366;FONT-WEIGHT: bold"></TD>
