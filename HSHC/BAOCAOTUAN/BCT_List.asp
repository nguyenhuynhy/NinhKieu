...
<%
	function getDSBaoCao(strBoPhan, strLoaiBaoCao, strTuNgay, strDenNgay,strNoiDung, strTieuDe)
		...
		com.Parameters.Append com.CreateParameter(,adVarChar,adParamInput,8,trim(strBoPhan))
...
'		'------- xoa file truoc
'		dim strFileName, myfile, sFolder
'		strFileName = getFileName(strMaBaoCao)
...
<%if strNSDQuan = true then%>              
			<option value="%">T&#7845;t c&#7843;</option>              
              <%
              	...
              	set rs = getBoPhanbyUser(Session("UserID"))
...
<%		
	...
	%>                      
       ...
       <table CssClass="QH_DataGrid"   cellSpacing="0" cellPadding="2" width="780" border="1" style="border-collapse: collapse">
		<tr align="center" bgcolor="#FCE8A0">
            <td nowrap width="3%" bgcolor="#448A37">
            <font color="#FFFFFF"><b>STT</b></font></td>
            <td nowrap bgcolor="#448A37">
            &nbsp;</td>
...
%>          
		<tr align="center" bgcolor="<%=strBgColor%>">
            ...
            <td nowrap><input type="checkbox" name="chkDelete" value="<%=rs("MaBaoCao")%>"></td>
