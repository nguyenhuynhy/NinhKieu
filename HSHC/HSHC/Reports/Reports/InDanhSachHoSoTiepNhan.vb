...
Public Class InDanhSachHoSoTiepNhan
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "InDanhSachHoSoTiepNhan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInDanhSachHoSoTiepNhan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InDanhSachHoSoTiepNhan = New InDanhSachHoSoTiepNhan
        rpt.Site = Me.Site
        Return rpt
    End Function
