...
Public Class InPhieuChuyenDatDaiVungHa
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "InPhieuChuyenDatDaiVungHa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInPhieuChuyenDatDaiVungHa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InPhieuChuyenDatDaiVungHa = New InPhieuChuyenDatDaiVungHa
        rpt.Site = Me.Site
        Return rpt
    End Function
