...
Public Class InPhieuChuyenDatDaiVungThuong
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "InPhieuChuyenDatDaiVungThuong.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInPhieuChuyenDatDaiVungThuong
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InPhieuChuyenDatDaiVungThuong = New InPhieuChuyenDatDaiVungThuong
        rpt.Site = Me.Site
        Return rpt
    End Function
