...
Public Class ChiTietGiaiQuyetHoSo
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "ChiTietGiaiQuyetHoSo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChiTietGiaiQuyetHoSo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChiTietGiaiQuyetHoSo = New ChiTietGiaiQuyetHoSo
        rpt.Site = Me.Site
        Return rpt
    End Function
