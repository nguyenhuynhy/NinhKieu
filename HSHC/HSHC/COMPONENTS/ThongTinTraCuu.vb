...
Imports System.Web
Namespace HSHC
    <Serializable()> Public Class TraCuu
    ...
    Public Class ThongTinTraCuuController
        Public Function GetInfoFromSearchTGLD(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
        ...
        End Function
        Public Function GetInfoFromSearchDauKy(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
        ...
        Public Function GetInfoFromSearch(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
            Return DataProvider.Instance.ExecuteQueryStoreProc("sp_GetDanhSachHoSo", _
                                                            ...
                                                            objTTTCInfo.LoaiHoSo, objTTTCInfo.TinhTrang, _
                                                             objTTTCInfo.URL, objTTTCInfo.NguoiTacNghiep)
        End Function
        Public Function GetInfoFromSearchThuLePhi(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Public Function GetDSHoSoThuLy(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
        ...
        Public Function GetInfoFromSearchCapSoBangTay(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Public Function GetDSHoSoChuyenThuLy(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
        ...
        End Function
        Public Function GetDSHoSoChuyenThuLyMotCua(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
        ...
        End Function
        Public Function GetDanhSachHoSoCD1(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
            Return DataProvider.Instance.ExecuteQueryStoreProc("sp_GetDanhSachHoSoChuyen", _
                                                                        ...
                                                                        objTTTCInfo.URL)
        End Function
        Public Function GetDSHoSoThuLyMotCua(ByVal objTTTCInfo As ThongTinTraCuuInfo) As DataSet
