<%@ Control Language="vb" AutoEventWireup="false" Codebehind="DanhSachHoSoTraDan.ascx.vb" Inherits="HSHC.DanhSachHoSoTraDan" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
											...
											<TD vAlign="top" width="100%">
												<table class="QH_LoaiHS" id="tblHeader" width="100%" align="center" runat="server">
													<TR vAlign="middle">
														...
														<TD vAlign="middle" align="left" width="20%" colSpan="1" rowSpan="1"><asp:linkbutton id="btnThucHien" CssClass="QH_Button" runat="server" Visible="False">Thực hiện</asp:linkbutton></TD>
													</TR>
												</table>
											</TD>
										</TR>
																...
																<TR>
																	<TD>
																		<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
																			...
																			<tr>
																				<TD align="right" width="*"><asp:label id="Label1" CssClass="QH_ColLabel1" Runat="server">Số dòng hiển thị</asp:label><asp:textbox id="txtSoDong" Width="50px" CssClass="QH_TextRight" AutoPostBack="True" Runat="server"
