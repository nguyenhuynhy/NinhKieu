<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongKeBaoCao.ascx.vb" Inherits="HSHC.ThongKeBaoCao" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
											...
											<TD>
												<TABLE class="QH_LoaiHS" id="tblHeader" width="100%" align="center" runat="server">
													<TR vAlign="middle">
														...
														<TD vAlign="middle" align="left" width="60%"><asp:dropdownlist id="ddlLinhVuc" Width="95%" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
