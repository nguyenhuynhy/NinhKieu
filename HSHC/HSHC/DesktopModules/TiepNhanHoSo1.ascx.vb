...
#End Region
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            m_HoSoID = TiepNhanCon.UpdHoSoTiepNhan1(txtHoSoTiepNhanID.Text, txtNgayHopLe.Text, txtSoNgayGiaiQuyet.Text, Request("tabid"), txtMaNguoiNhan.Text, txtMaTinhTrang.Text, txtNoiDungKhac.Text)
            SetFocus(Me.Page, txtNgayHopLe)
