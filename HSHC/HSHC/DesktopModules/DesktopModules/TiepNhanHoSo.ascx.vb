...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents txtSoNgayDoDac As System.Web.UI.WebControls.TextBox
        Protected WithEvents txtSoNgayNopBienBan As System.Web.UI.WebControls.TextBox
        Protected WithEvents btnInPhieuChuyen As System.Web.UI.WebControls.LinkButton
        Protected WithEvents tdInPhieuChuyen As System.Web.UI.HtmlControls.HtmlTableCell
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not Page.IsPostBack Then
                ...
                'phuocdd, updated 9/5/2007, khong dieu khien button kiem tra, theo yeu cau cua khach hang
                'HienThiChucNangKiemTra()
            End If
            ...
            If Not ConfigurationSettings.AppSettings("EnableNgayNhan" & Request.Params("TabID")) Is Nothing Then
                ...
                'phuocdd, Sep 28th 2007, update, ngay hen tra duoc tinh duoi database
            ...
            Else
                ...
                'phuocdd, Sep 28th 2007, update, ngay hen tra duoc tinh duoi database
                'Me.btnCapNhat.Attributes.Add("onfocus", "javascript:CheckDateOnBlur_GetNgayBoSung(" & txtNgayHopLe.ClientID & "," & txtSoNgayGiaiQuyet.ClientID & ",'" & mNgayNghiLe & "'," & txtNgayHenTra.ClientID & ");")
        ...
        Sub Init_State()
            ...
            If txtMaLinhVuc.Text = "CPKT" Then Label2.Text = "Địa chỉ đăng ký kinh doanh"
            If txtMaLinhVuc.Text = "CPXD" Then Label2.Text = "Địa chỉ đăng ký xây dựng"
            If txtMaLinhVuc.Text = "SD181" Then Label2.Text = "Địa chỉ đăng ký đất"
            If txtMaLinhVuc.Text <> "CPKB" Then
            ...
            Else
                ...
                If pID = "" Then
                    ...
                    Init_SoNgayDoDac(ddlMaLoaiHoSo.SelectedValue, txtMaLinhVuc.Text)
                    Init_SoNgayNopBienBan(ddlMaLoaiHoSo.SelectedValue, txtMaLinhVuc.Text)
            ...
            If Not ConfigurationSettings.AppSettings("BSHS" & Request.Params("TabID")) Is Nothing Then
                ...
                txtSoNgayDoDac.Enabled = True
                txtSoNgayNopBienBan.Enabled = True
            End If
        ...
        Sub Init_SoNgayGiaiQuyet(ByVal pMaLoaiHoSo As String, ByVal pLinhvuc As String)
            ...
            TiepNhanCon = Nothing
        End Sub
        Sub Init_SoNgayDoDac(ByVal pMaLoaiHoSo As String, ByVal pLinhvuc As String)
            Dim TiepNhanCon As New TiepNhanHoSoController
            txtSoNgayDoDac.Text = TiepNhanCon.getSoNgayDoDac(pMaLoaiHoSo, pLinhvuc)
            TiepNhanCon = Nothing
        End Sub
        Sub Init_SoNgayNopBienBan(ByVal pMaLoaiHoSo As String, ByVal pLinhvuc As String)
            Dim TiepNhanCon As New TiepNhanHoSoController
            txtSoNgayNopBienBan.Text = TiepNhanCon.getSoNgayNopBienBan(pMaLoaiHoSo, pLinhvuc)
            TiepNhanCon = Nothing
        End Sub
        ...
        Private Sub ddlMaLoaiHoSo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlMaLoaiHoSo.SelectedIndexChanged
            ...
            Init_SoNgayDoDac(ddlMaLoaiHoSo.SelectedItem.Value, txtMaLinhVuc.Text)
            Init_SoNgayNopBienBan(ddlMaLoaiHoSo.SelectedItem.Value, txtMaLinhVuc.Text)
            Set_Attribute()
        End Sub
        ...
        Sub Set_Attribute()
            ...
            txtSoNgayDoDac.Attributes.Add("ISNULL", "NOTNULL")
            txtSoNgayNopBienBan.Attributes.Add("ISNULL", "NOTNULL")
        ...
        Private Sub btnInPhieuChuyen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInPhieuChuyen.Click
            ...
            ds = objTiepNhan.InPhieuChuyen(txtHoSoTiepNhanID.Text)
            Script = String.Format("<script language='javascript'>window.open('{0}', '_blank');</script>", InPhieuChuyen(Request, ds, GetLinhVuc()))
