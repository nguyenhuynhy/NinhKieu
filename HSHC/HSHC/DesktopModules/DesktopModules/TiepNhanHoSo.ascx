...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="TiepNhanHoSo.ascx.vb" Inherits="HSHC.TiepNhanHoSo" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
			...
			<table border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tr>
					...
					<td align="center">
														...
														<TD vAlign="top" width="50%">
															<TABLE id="Table4" class="QH_Table" border="0" cellSpacing="0" cellPadding="0" width="100%">
																<TR>
																	...
																	<TD class="QH_ColControl"><asp:dropdownlist id="ddlMaLoaiHoSo" Width="93%" runat="server" CssClass="QH_DropDownList" AutoPostBack="True"></asp:dropdownlist></TD>
																</TR>
																<TR>
														...
														<TD vAlign="top">
															<TABLE id="Table16" class="QH_Table" border="0" cellSpacing="0" cellPadding="0" width="100%">
																<TR>
																	...
																	<TD class="QH_ColControl" width="55"><asp:textbox id="txtSoNgayGiaiQuyet" Width="30px" runat="server" CssClass="QH_TextRight" MaxLength="4"></asp:textbox>&nbsp;<span class="QH_LabelNote">( 
                                Ngày)</span></TD>
																	<TD class="QH_ColLabel" width="175">Số ngày ĐĐ</TD>
																	<TD class="QH_ColControl" width="124"><asp:textbox id="txtSoNgayDoDac" Width="30px" runat="server" CssClass="QH_TextRight" MaxLength="4"></asp:textbox>&nbsp;<span class="QH_LabelNote">( 
                                Ngày)</span></TD>
																	<TD class="QH_ColLabel" width="153">Số ngày nộp BB</TD>
																	<TD class="QH_ColControl" width="22%"><asp:textbox id="txtSoNgayNopBienBan" Width="30px" runat="server" CssClass="QH_TextRight" MaxLength="4"></asp:textbox>&nbsp;<span class="QH_LabelNote">( 
                                Ngày)</span></TD>
																</TR>
																<TR>
																	<TD class="QH_ColLabel" width="22%">Ngày hẹn trả</TD>
																	<TD class="QH_ColControl" width="55"><asp:textbox id="txtNgayHenTra" Width="70px" runat="server" CssClass="QH_Textbox" ReadOnly="True"></asp:textbox></TD>
																	<TD class="QH_ColLabel" width="175"></TD>
																	<TD class="QH_ColLabel" width="124"><asp:checkbox id="chkNTD" runat="server"></asp:checkbox>Ngày 
																		thực địa</TD>
																	<TD class="QH_ColControl" width="153"><asp:textbox style="Z-INDEX: 0" id="txtNgayThucDia" Width="70px" runat="server" CssClass="QH_Textbox"></asp:textbox></TD>
																	<TD class="QH_ColControl"><asp:textbox id="txtSoNgayThucDia" Width="0" runat="server" CssClass="QH_TextRight" MaxLength="4"
														...
														<TD vAlign="middle" width="100%" colSpan="2" align="center">
															<table>
																<tr>
																	...
																	<td id="tdInPhieuChuyen" runat="server"><asp:linkbutton id="btnInPhieuChuyen" runat="server" CssClass="QH_Button">In phiếu chuyển</asp:linkbutton></td>
																	<td><asp:linkbutton id="btnTraHoSo" runat="server" CssClass="QH_Button" Visible="False">Trả hồ sơ</asp:linkbutton></td>
						...
						<asp:textbox id="txtHoSoTiepNhanID" Width="0px" runat="server" CssClass="QH_Textbox" Visible="true"></asp:textbox><asp:textbox id="txtMaNguoiNhan" Width="0px" runat="server" CssClass="QH_Textbox" Visible="true"></asp:textbox><asp:textbox id="txtMaLinhVuc" Width="0px" runat="server" CssClass="QH_Textbox" Visible="true"></asp:textbox></td>
