...
Namespace HSHC
    Public Class ThuLyHoSoThuLePhi
...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            objThongTinTraCuuInfo.URL = EditURL("ID", "VALUE", "THULEPHI")
            objThongTinTraCuuInfo.ItemCode = CType(Session.Item("ItemCode"), String)
            objThongTinTraCuuInfo.NguoiTacNghiep = CType(Session.Item("UserName"), String)
            ds = objThongTinTraCuuCtrl.GetInfoFromSearchThuLePhi(objThongTinTraCuuInfo)
            'PhuocDD updated Mar 31st 2006
            ...
            '                                               "100, 0, 150, 200, 70, 0,150,0,150,70", False, True)
