<%@ Register TagPrefix="uc1" TagName="NhapMoiChucNang" Src="NhapMoiChucNang.ascx" %>
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="PhanQuyenUser.ascx.vb" Inherits="PortalQH.PhanQuyenUser" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD vAlign="top" width="100%">
									<table class="QH_LoaiHS" width="100%" align="center">
										<TR vAlign="middle">
											<TD vAlign="middle" align="right" width="25%" height="50"><STRONG>Danh sách tab</STRONG>
											</TD>
											<TD vAlign="middle" align="left" width="40%"><asp:dropdownlist id="ddlTab" runat="server" Width="100%"></asp:dropdownlist></TD>
											<TD vAlign="middle" align="left" width="*"><asp:LinkButton CssClass="QH_Button" id="btnThucHien" runat="server">Thực hiện</asp:LinkButton></TD>
										</TR>
									</table>
								</TD>
							</TR>
										...
										<tr>
											...
											<td vAlign="top" width="70%">
												<table width="100%">
													...
													<tr>
														<td><uc1:nhapmoichucnang id="NhapMoiChucNang1" runat="server"></uc1:nhapmoichucnang></td>
													</tr>
													<tr>
														<td align="center">
															<asp:LinkButton CssClass="QH_Button" id="btnCapNhatChucNang" runat="server">Cập nhật chức năng</asp:LinkButton>
															<asp:LinkButton CssClass="QH_Button" id="btnBoQuaChucNang" runat="server">Bỏ qua chức năng</asp:LinkButton></td>
													</tr>
												</table>
											</td>
										</tr>
