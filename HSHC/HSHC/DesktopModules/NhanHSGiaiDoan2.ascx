...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="NhanHSGiaiDoan2.ascx.vb" Inherits="HSHC.NhanHSGiaiDoan2" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
																		...
																		<TR>
																			...
																			<TD>
																				<TABLE id="Table13" cellSpacing="0" cellPadding="0" width="100%" border="0">
																					...
																					<TR>
																						<TD height="67"><asp:textbox id="txtNoiDungTrichYeu" runat="server" Width="97%" CssClass="QH_Textbox" Rows="4"
																...
																<TD vAlign="top" width="50%">
																	<TABLE class="QH_Table" id="Table15" cellSpacing="0" cellPadding="0" width="100%" border="0">
																		<TR>
																			...
																			<TD class="QH_ColControl"><asp:textbox id="txtNgayNhan" runat="server" Width="70px" CssClass="QH_Textbox" ReadOnly="True"
																...
																<TD vAlign="top">
																	<TABLE class="QH_Table" id="Table16" cellSpacing="0" cellPadding="0" width="100%" border="0">
																		<TR>
																			...
																			<TD class="QH_ColControl" width="22%"><asp:textbox id="txtSoNgayGiaiQuyet" runat="server" Width="30px" CssClass="QH_TextRight" MaxLength="4"></asp:textbox>&nbsp;<span class="QH_LabelNote">( Ngày 
                                )</span></TD>
																			<TD width="25%"></TD>
																			<TD width="22%"></TD>
																		</TR>
																		...
																		<TR>
																			...
																			<TD vAlign="top">
																				<TABLE id="Table12" cellSpacing="0" cellPadding="0" width="100%" border="0">
																					...
																					<TR>
																						<TD><asp:textbox id="txtNoiDungKhac" runat="server" Width="97%" CssClass="QH_Textbox" ReadOnly="True"
