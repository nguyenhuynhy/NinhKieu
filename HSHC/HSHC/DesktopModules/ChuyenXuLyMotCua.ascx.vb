...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not Me.IsPostBack Then
                ...
                If txtSoBienNhan.Text <> "" Then
                    LoadData()
                End If
                BindControl.BindDropDownList_StoreProc(ddlMaTinhTrangXuLy, False, "", "sp_getTinhTrangHoSoByLoaiMotCua", CType(Session.Item("ItemCode"), String), Request.Params("tabid"), "XL", txtHoSoTiepNhanID.Text)
        ...
        Private Sub LoadData()
            ...
            Dim rs As DataSet
            rs = objTinhTrangHoSo.GetChuyenXuLy(txtSoBienNhan.Text)
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            Dim objTinhTrangHoSo As New TinhTrangHoSoController
            objTinhTrangHoSo.UpdChuyenXuLy(Me)
