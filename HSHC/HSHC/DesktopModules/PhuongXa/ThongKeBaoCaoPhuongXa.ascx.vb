...
Namespace HSHC
    ...
    'Updated on : 
    Public Class ThongKeBaoCaoPhuongXa
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                If Not Page.IsPostBack Then
                    ...
                    'HieuLc3 chi co user : admin, host moi thay dc danh sach Phuong
                    If (CType(Session.Item("UserName"), String) = "admin" Or CType(Session.Item("UserName"), String) = "host" Or CType(Session.Item("UserName"), String) = "suonghh" Or CType(Session.Item("UserName"), String) = "minhvd") Then
                    ...
                    Else
                        lblPhuong.Visible = False
                        ddlMaPhuong.Visible = False
                    End If
                    'end HieuLc3
                End If

                txtUserName.Text = CType(Session.Item("UserName"), String)
                Init_State()
                getUserControlList()
        ...
        Sub Init_Report()
            ...
            GetReport_TKBC_phuongXa(Request.Params("TabId").ToString, CType(Session.Item("MaLinhVuc"), String), CStr(Session.Item("UserID")), strItemCode, "HSHC", btnIn, Me)
        End Sub
        ...
        Private Sub ddlLinhVuc_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlLinhVuc.SelectedIndexChanged
            If ddlLinhVuc.SelectedIndex > -1 Then
                ...
                If Request.Params("SelectID") <> "" Then
                    ...
                    'GetReportphuongXa(Request.Params("TabId").ToString, CType(Session.Item("MaLinhVuc"), String), Request.Params("SelectID"), "HSHC", btnIn, Me)
                    GetReport_TKBC_phuongXa(Request.Params("TabId").ToString, CType(Session.Item("MaLinhVuc"), String), CStr(Session.Item("UserID")), Request.Params("SelectID"), "HSHC", btnIn, Me)
                Else
                    'GetReportURL(Request.Params("TabId").ToString, CType(Session.Item("MaLinhVuc"), String), "1", "HSHC", btnIn, Me)
                    'GetReportphuongXa(Request.Params("TabId").ToString, CType(Session.Item("MaLinhVuc"), String), "1", "HSHC", btnIn, Me)
                    GetReport_TKBC_phuongXa(Request.Params("TabId").ToString, CType(Session.Item("MaLinhVuc"), String), CStr(Session.Item("UserID")), "1", "HSHC", btnIn, Me)
                End If
            End If
        End Sub
