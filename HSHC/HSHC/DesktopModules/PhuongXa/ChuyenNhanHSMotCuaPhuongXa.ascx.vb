...
Namespace HSHC
    Public Class ChuyenNhanHSMotCuaPhuongXa
        Inherits PortalQH.PortalModuleControl
        Protected WithEvents ThongTinTraCuuChuyenNhan1Cua1 As ThongTinTraCuuChuyenNhan1CuaPhuongXa
...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            ds = objThongTinTraCuuCtrl.GetDSHoSoChuyenThuLyMotCuaPhuongXa(objThongTinTraCuuInfo)
        ...
        Private Sub btnTimKiem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTimKiem.Click
            Try
                If Not ThongTinTraCuuChuyenNhan1Cua1 Is Nothing Then
                    Dim objThongTin As ThongTinTraCuuPhuongXaInfo
                    objThongTin = ThongTinTraCuuChuyenNhan1Cua1.GetValues()
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            objThongTinTraCuuInfo = ThongTinTraCuuChuyenNhan1Cua1.GetValues()
        ...
        Private Sub ddlLinhVuc_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlLinhVuc.SelectedIndexChanged
            ...
            Session("ThongTinTraCuuPhuongXaInfo") = objThongTinTraCuuInfo
            ThongTinTraCuuChuyenNhan1Cua1.BindData(ddlLinhVuc.SelectedValue)
            LoadGrid()
            SetAttributesControl()
        End Sub
