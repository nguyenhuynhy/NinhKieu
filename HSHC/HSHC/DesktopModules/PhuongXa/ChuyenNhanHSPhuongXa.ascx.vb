...
Namespace HSHC
    Public Class ChuyenNhanHSPhuongXa
        Inherits PortalQH.PortalModuleControl
        Protected WithEvents ThongTinTraCuuChuyenNhan1 As ThongTinTraCuuChuyenNhanPhuongXa
...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            ds = objThongTinTraCuuCtrl.GetDSHoSoChuyenThuLyPhuongXa(objThongTinTraCuuInfo)
