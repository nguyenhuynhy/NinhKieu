<%@ Control Language="vb" AutoEventWireup="false" Codebehind="TiepNhanHoSoListPhuongXa.ascx.vb" Inherits="HSHC.TiepNhanHoSoListPhuongXa" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
															...
															<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%" border="0">
																...
																<TR>
																	<TD align="center"><asp:linkbutton id="btnTimKiem" CssClass="QH_Button" runat="server">Tìm kiếm</asp:linkbutton>
																		...
																		<asp:linkbutton id="btnInDanhSach" CssClass="QH_Button" runat="server">In Danh Sách</asp:linkbutton></TD>
																</TR>
																<TR>
