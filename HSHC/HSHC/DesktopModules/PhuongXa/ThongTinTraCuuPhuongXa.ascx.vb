...
Namespace HSHC
    Public Class ThongTinTraCuuPhuongXa
...
#End Region
        ...
        Public Sub BindData(ByVal ItemCode As String)
            ...
            BindControl.BindDropDownList(ddlPhuong, "DMPHUONG", pMaPhuong, True)
            ...
            If CType(ConfigurationSettings.AppSettings("LocDuong"), String) <> "0" Then
                ...
                BindDropDownList_Dataset(ddlPhuong, dsPhuong, "Ten", "Ma", True, pMaPhuong)
        ...
        Public Sub SetValues(ByVal objThongTinTraCuuInfo As ThongTinTraCuuPhuongXaInfo)
            ...
            Else
                Me.ddlPhuong.SelectedValue = pMaPhuong 'dieu chinh cho phu hop voi phuong
            End If
