Imports PortalQH
Namespace HSHC
    Public Class ChuyenXuLyMotCuaNhieuHSPhuongXa
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not Me.IsPostBack Then
                ...
                BindControl.BindDropDownList_StoreProc(ddlMaNguoiDen, True, CType(Session.Item("UserName"), String), "sp_getNguoiSuDungPhuongXa", Request.Params("tabid"), CType(Session.Item("ItemCode"), String), CType(Session.Item("UserName"), String), "C")
                BindControl.BindDropDownList_StoreProc(ddlMaNguoiNhan, True, "", "sp_getNguoiSuDungPhuongXa", Request.Params("tabid"), CType(Session.Item("ItemCode"), String), CType(Session.Item("UserName"), String), "N")
        ...
        Private Sub LoadData()
            Dim objTinhTrangHoSo As New TinhTrangHoSoPhuongXaController
            Dim rs As DataSet
