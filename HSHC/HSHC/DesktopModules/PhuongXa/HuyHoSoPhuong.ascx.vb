...
#End Region
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            Dim TinhTrangCon As New TinhTrangHoSoPhuongXaController
            Dim objHoSoHuy As New HoSoHuyPhuongXaController
            ...
            If strHoSoHuyID <> "" Then
                ...
                If strDaHuy = "0" Then
                    err = TinhTrangCon.UpdTinhTrangHoSo(Request.Params("Malv"), _
                                Request.Params("TabID"), "HUYP", txtNguoiHuy.Text, txtNguoiHuy.Text, txtNguoiHuy.Text, _
