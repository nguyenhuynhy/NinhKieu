...
Namespace HSHC
    Public Class ThongTinTraCuuChuyenNhanPhuongXa
...
#End Region
        ...
        Public Sub BindData(ByVal ItemCode As String)
            ...
            BindControl.BindDropDownList_StoreProc(ddlNguoiChuyen, True, "", "sp_getNguoiSuDungPhuongXa", Request.Params("tabid"), ItemCode, Session.Item("UserName"), "c")
            ...
            End If
            BindControl.BindDropDownList_StoreProc(ddlNguoiNhan, True, "", "sp_getNguoiSuDungPhuongXa", Request.Params("tabid"), ItemCode, Session.Item("UserName"), "n")
        End Sub
