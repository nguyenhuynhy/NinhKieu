<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongKe_ChiTietHoSo.ascx.vb" Inherits="HSHC.ThongKe_ChiTietHoSo" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
				...
				<tr>
					...
					<td align="center" width="*">
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD align="center" colSpan="3"><asp:linkbutton id="btnGui" CssClass="QH_Button" runat="server">Gửi tin nhắn</asp:linkbutton>&nbsp;
