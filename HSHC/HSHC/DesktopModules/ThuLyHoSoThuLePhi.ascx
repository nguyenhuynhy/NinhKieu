...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThuLyHoSoThuLePhi.ascx.vb" Inherits="HSHC.ThuLyHoSoThuLePhi" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
									...
									<TABLE id="Table11" border="0" cellSpacing="0" cellPadding="0" width="100%">
										<TR>
											<TD vAlign="top" width="100%">
												<TABLE id="tblHeader" class="QH_LoaiHS" cellSpacing="0" cellPadding="0" width="100%" align="center"
													runat="server">
													<TR vAlign="middle">
														<TD height="0" vAlign="middle" width="20%" align="right"><STRONG>Loại hồ sơ</STRONG>&nbsp;
														</TD>
														<TD vAlign="middle" width="60%" align="left"><asp:dropdownlist id="ddlLinhVuc" Width="95%" runat="server" AutoPostBack="True" CssClass="QH_DropDownList"></asp:dropdownlist></TD>
														<TD vAlign="middle" width="20%" align="left"><asp:linkbutton id="btnThucHien" CssClass="QH_Button" runat="server" Visible="False">Thực hiện</asp:linkbutton></TD>
													</TR>
												</TABLE>
											</TD>
										</TR>
																...
																<TR>
																	<TD>
																		<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="0" width="100%">
																			...
																			<TR>
																				<TD colSpan="2" align="center"><asp:linkbutton id="btnTimKiem" CssClass="QH_Button" runat="server">Tìm kiếm</asp:linkbutton></TD>
																			</TR>
																			<tr>
																				<TD width="50%" align="left"><asp:label id="Label2" ForeColor="Navy" BorderColor="Blue" Runat="server">Tổng số hồ sơ:</asp:label><asp:label id="lblTongSoHoSo" ForeColor="Navy" Runat="server" Font-Bold="True"></asp:label></TD>
																				<TD width="*" align="right"><asp:label id="Label1" CssClass="QH_ColLabel1" Runat="server">Số dòng hiển thị</asp:label><asp:textbox id="txtSoDong" CssClass="QH_TextRight" Width="50px" Runat="server" MaxLength="3"
