<%@ Control Language="vb" AutoEventWireup="false" Codebehind="HuyHoSo.ascx.vb" Inherits="HSHC.HuyHoSo" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
