...
Namespace HSHC
    Public Class ThongTinTraCuuChuyenNhan1Cua
...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents txtNgayChuyen As System.Web.UI.WebControls.TextBox
        ...
        Protected WithEvents cmdNgayChuyen As System.Web.UI.WebControls.HyperLink
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                Me.txtNgayChuyen.Attributes.Add("onblur", "javascript:CheckDateOnBlur(" & txtNgayChuyen.ClientID & ");")
                '                Me.ImgNgayChuyen.Attributes.Add("onclick", "javascript:popUpCalendar(this, " & txtNgayChuyen.ClientID & ", 'dd/mm/yyyy')")

                cmdNgayChuyen.NavigateUrl = AdminDB.InvokePopupCal(txtNgayChuyen)

                _objThongTinTraCuuInfo = CType(Session("ThongTinTraCuuInfo"), ThongTinTraCuuInfo)
        ...
        Public Sub BindData(ByVal ItemCode As String)
            ...
            BindControl.BindDropDownList_StoreProc(ddlNguoiChuyen, True, "", "sp_GetNguoiSuDung", Request.Params("tabid"), ItemCode, Session.Item("UserName"), "c")
            If CType(Session.Item("UserName"), String) <> "" Then
                ddlNguoiChuyen.SelectedIndex = ddlNguoiChuyen.Items.IndexOf(ddlNguoiChuyen.Items.FindByValue(CStr(Session("UserName"))))
            End If
            BindControl.BindDropDownList_StoreProc(ddlNguoiNhan, True, "", "sp_GetNguoiSuDung", Request.Params("tabid"), ItemCode, Session.Item("UserName"), "n")
        End Sub
        ...
        Public Function GetValues() As ThongTinTraCuuInfo
            ...
            _objThongTinTraCuuInfo.NguoiChuyen = Me.ddlNguoiChuyen.SelectedValue
            _objThongTinTraCuuInfo.NguoiNhan = Me.ddlNguoiNhan.SelectedValue
            _objThongTinTraCuuInfo.NgayTacNghiep = Me.txtNgayChuyen.Text
            Return _objThongTinTraCuuInfo
        End Function
        ...
        Public Sub SetValues(ByVal objThongTinTraCuuInfo As ThongTinTraCuuInfo)
            ...
            Me.txtNgayChuyen.Text = objThongTinTraCuuInfo.NgayTacNghiep
            ...
            If objThongTinTraCuuInfo.NguoiChuyen <> "" Then
                DdLSelected(ddlNguoiChuyen, objThongTinTraCuuInfo.NguoiChuyen)
            Else
                If CType(Session.Item("UserName"), String) <> "" Then
                    ddlNguoiChuyen.SelectedIndex = ddlNguoiChuyen.Items.IndexOf(ddlNguoiChuyen.Items.FindByValue(CStr(Session("UserName"))))
                End If
            End If
            If objThongTinTraCuuInfo.NguoiNhan <> "" Then
                DdLSelected(ddlNguoiNhan, objThongTinTraCuuInfo.NguoiNhan)
            End If
        End Sub
    End Class
End Namespace