...
Namespace HSHC
    Public Class ThuLyHoSoMotCuaNhieuHS
...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents ThongTinTraCuu1 As ThongTinTraCuuMotCua
...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            ds = objThongTinTraCuuCtrl.GetDSHoSoThuLyMotCua(objThongTinTraCuuInfo)
        ...
        Private Sub AddAttributeCheckbox()
            ...
            For i = 0 To dgdHoSoThuLy.Controls(0).Controls.Count - 1
                chk = CType(dgdHoSoThuLy.Controls(0).Controls(i).FindControl("chkXoa"), CheckBox)
