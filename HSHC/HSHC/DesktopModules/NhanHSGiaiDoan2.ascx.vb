...
#End Region
        ...
        Sub Init_SoNgayGiaiQuyet(ByVal pMaLoaiHoSo As String, ByVal pLinhvuc As String)
            Dim TiepNhanCon As New TiepNhanHoSoController
            txtSoNgayGiaiQuyet.Text = TiepNhanCon.getSoNgayGiaiDoan2(pMaLoaiHoSo, pLinhvuc)
            TiepNhanCon = Nothing
        End Sub
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            m_HoSoID = TiepNhanCon.UpdNhanHSGiaiDoan2(txtHoSoTiepNhanID.Text, txtNgayHopLe.Text, txtSoNgayGiaiQuyet.Text, Request("tabid"), txtMaNguoiNhan.Text, txtMaTinhTrang.Text, ddlMaLoaiHoSo.SelectedValue)
            SetFocus(Me.Page, txtNgayHopLe)
