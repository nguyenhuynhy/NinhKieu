<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ChuyenXuLyMotCua.ascx.vb" Inherits="HSHC.ChuyenXuLyMotCua" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
