<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongKeHoSo.ascx.vb" Inherits="HSHC.ThongKeHoSo" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
							...
							<TR>
								...
								<TD width="*">
									<TABLE class="QH_Table" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD width="25%"><asp:label id="Label1" Runat="server" Width="100%" CssClass="QH_LabelLeft">Linh v?c ti?p nh?n</asp:label></TD>
										...
										<TR>
											<TD><asp:label id="Label2" Runat="server" Width="100%" CssClass="QH_LabelLeft">Lo?i h? so</asp:label></TD>
							...
							<TR>
								<TD colSpan="3" align="right">
									<asp:Label ID="Label4" Runat="server" CssClass="QH_ColLabel1">S? dòng hi?n th?</asp:Label>
							...
							<TR>
								<TD colspan="3" align="center">
									<asp:linkbutton id="btnTroVe" runat="server" CssClass="QH_Button">Tr? v?</asp:linkbutton></TD>
							</TR>
						</TABLE>
					</td>
