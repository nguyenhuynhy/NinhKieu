...
Imports PortalQH
Namespace HSHC
    Public Class DanhSachHoSoTraDan
...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            For i = 0 To grdDanhSach.Items.Count - 1
                ...
                If ds.Tables(0).Rows(item).Item("Tình trạng").ToString = "DTD" Then
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            Dim objTiepNhanHSCtrl As New TiepNhanHoSoController
            ...
            If flgUpdated Then
                ThongTinTraCuu1.SetValues(CType(Session("ThongTinTraCuuInfo"), ThongTinTraCuuInfo))
                LoadGrid()
            Else
