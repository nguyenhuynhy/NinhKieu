...
Namespace HSHC
    Public Class ChuyenNhanHSMotCua
        Inherits PortalQH.PortalModuleControl
        Protected WithEvents ThongTinTraCuuChuyenNhan1Cua1 As ThongTinTraCuuChuyenNhan1Cua
...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            ds = objThongTinTraCuuCtrl.GetDSHoSoChuyenThuLyMotCua(objThongTinTraCuuInfo)
