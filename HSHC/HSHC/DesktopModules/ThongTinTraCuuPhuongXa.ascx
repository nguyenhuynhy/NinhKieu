...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongTinTraCuuPhuongXa.ascx.vb" Inherits="HSHC.ThongTinTraCuuPhuongXa" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
...
<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" class="QH_Table">
	...
	<TR>
		<TD class="QH_ColLabel" width="15%">
			Phường</TD>
		<TD Width="35%" class="QH_ColControl">
			<cc1:KeySortDropDownList id="ddlPhuong" Width="90%" runat="server" CssClass="QH_DropDownList" Enabled="False"></cc1:KeySortDropDownList></TD>
