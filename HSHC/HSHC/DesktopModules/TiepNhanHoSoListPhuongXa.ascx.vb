...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents btnInSo As System.Web.UI.WebControls.LinkButton
...
#End Region
        ...
        Private Sub btnInSo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInSo.Click
            Dim linhvuc As String
            linhvuc = ddlLinhVuc.SelectedValue.ToString()

            Response.Write("<script>")
            Response.Write("window.open('hshc/InSo.aspx?LINHVUC=" + linhvuc + "','_blank')")
            Response.Write("</script>")
        End Sub
    End Class
End Namespace
