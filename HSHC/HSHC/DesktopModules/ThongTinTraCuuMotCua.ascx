...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongTinTraCuuMotCua.ascx.vb" Inherits="HSHC.ThongTinTraCuuMotCua" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
