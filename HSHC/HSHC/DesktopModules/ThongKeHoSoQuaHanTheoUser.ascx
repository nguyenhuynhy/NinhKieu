<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongKeHoSoQuaHanTheoUser.ascx.vb" Inherits="HSHC.ThongKeHoSoQuaHanTheoUser" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
							...
							<TR>
								...
								<TD width="*">
									<TABLE class="QH_Table" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD width="25%"><asp:label id="Label5" Runat="server" Width="100%" CssClass="QH_LabelLeft">Tên cán bộ thụ lý</asp:label></TD>
											<TD class="QH_ColLabelLeft" width="5%">:</TD>
											<TD width="*"><asp:label id="lblNguoiThuLy" Runat="server" Width="100%" CssClass="QH_LabelLeftBold"></asp:label></TD>
										</TR>
										<TR>
								...
								<TD colspan="3" align="center">
									<asp:datagrid id="dgdDanhSach" Width="50%" CssClass="QH_DataGrid" autogeneratecolumns="false"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="TenTinhTrang" HeaderText="Tình trạng" HeaderStyle-Width="79%" />
											<asp:BoundColumn DataField="SoLanTreHan" HeaderText="Số lần trễ hạn" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="Center" />
										</Columns>
