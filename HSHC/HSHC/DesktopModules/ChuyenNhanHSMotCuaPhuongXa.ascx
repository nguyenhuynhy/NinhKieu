<%@ Register TagPrefix="uc1" TagName="ThongTinTraCuuChuyenNhan1Cua" Src="ThongTinTraCuuChuyenNhan1CuaPhuongXa.ascx" %>
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ChuyenNhanHSMotCuaPhuongXa.ascx.vb" Inherits="HSHC.ChuyenNhanHSMotCuaPhuongXa" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
											...
											<TD vAlign="top" width="100%">
												<table class="QH_LoaiHS" id="tblHeader" width="100%" align="center" runat="server">
													<TR vAlign="middle">
														...
														<TD vAlign="middle" align="left" width="20%"><asp:linkbutton id="btnThucHien" runat="server" CssClass="QH_Button" Visible="False">Th?c hi?n</asp:linkbutton></TD>
													</TR>
												</table>
											</TD>
										</TR>
															...
															<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%" border="0">
																...
																<TR>
																	<TD><asp:datagrid id="grdDanhSach" Width="100%" CssClass="QH_DataGrid" Runat="server" CellPadding="3"
																			...
																			<Columns>
																				<asp:BoundColumn Visible="False" DataField="HoSoTiepNhanID" HeaderText="H? so ti?p nh?n"></asp:BoundColumn>
