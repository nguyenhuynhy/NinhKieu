...
Namespace PortalQH.Data
    ...
    Public Class SqlDataProvider
        ...
        Public Overrides Function GetProviderPath() As String
            Dim objHttpContext As HttpContext = HttpContext.Current
            If Not objHttpContext.Session.Item("UserID") Is Nothing Then
                Dim a As String = objHttpContext.Session.Item("UserID").ToString
            End If
        ...
        Public Overrides Sub UpdatePortalInfo(ByVal PortalId As Integer, ByVal PortalName As String, ByVal PortalAlias As String, ByVal LogoFile As String, ByVal FooterText As String, ByVal ExpiryDate As Date, ByVal UserRegistration As Integer, ByVal BannerAdvertising As Integer, ByVal Currency As String, ByVal AdministratorId As String, ByVal HostFee As Double, ByVal HostSpace As Double, ByVal PaymentProcessor As String, ByVal ProcessorUserId As String, ByVal ProcessorPassword As String, ByVal Description As String, ByVal KeyWords As String, ByVal BackgroundFile As String, ByVal SiteLogHistory As Integer, ByVal HomeTabId As Integer, ByVal LoginTabId As Integer, ByVal UserTabId As Integer)
            ...
            SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner & ObjectQualifier & "UpdatePortalInfo", PortalId, PortalName, PortalAlias, GetNull(LogoFile), GetNull(FooterText), GetNull(ExpiryDate), UserRegistration, BannerAdvertising, Currency, AdministratorId, HostFee, HostSpace, GetNull(PaymentProcessor), GetNull(ProcessorUserId), GetNull(ProcessorPassword), GetNull(Description), GetNull(KeyWords), GetNull(BackgroundFile), GetNull(SiteLogHistory), GetNull(HomeTabId), GetNull(LoginTabId), GetNull(UserTabId))
        End Sub
        ...
        Public Overrides Function ExecuteSQL(ByVal SQL As String) As IDataReader
            ...
            End Try
        End Function
        Public Overrides Function ExecuteSQLApp(ByVal SQL As String) As IDataReader
            SQL = SQL.Replace("{databaseOwner}", DatabaseOwner)
            SQL = SQL.Replace("{objectQualifier}", ObjectQualifier)
            Try
                Return CType(SqlHelper.ExecuteReader(ConnectionStringApp, CommandType.Text, SQL), IDataReader)
            Catch
                ' error in SQL query
                Return Nothing
            End Try
        ...
        Public Overrides Function ExecuteSQLAppDataSet(ByVal SQL As String) As DataSet
            SQL = SQL.Replace("{databaseOwner}", DatabaseOwner)
            SQL = SQL.Replace("{objectQualifier}", ObjectQualifier)
            Try
                Return CType(SqlHelper.ExecuteDataset(ConnectionStringApp, CommandType.Text, SQL), DataSet)
            Catch
                ' error in SQL query
                Return Nothing
            End Try
        ...
        ' users
        Public Overrides Function AddUser(ByVal FullName As String, ByVal Unit As String, ByVal Street As String, ByVal City As String, ByVal Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal Telephone As String, ByVal Email As String, ByVal Username As String, ByVal Password As String, ByVal AffiliateId As Integer, ByVal ChucDanh As String, ByVal PhongBan As String) As String
            Try
                Return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner & ObjectQualifier & "AddUser", FullName, Unit, Street, City, Region, PostalCode, Country, Telephone, Email, Username, Password, GetNull(AffiliateId), ChucDanh, PhongBan), String)
            Catch ' duplicate
                Return ""
            End Try
        End Function
        ...
        End Sub
        Public Overrides Sub UpdateUser(ByVal UserId As String, ByVal FullName As String, ByVal Unit As String, ByVal Street As String, ByVal City As String, ByVal Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal Telephone As String, ByVal Email As String, ByVal Username As String, ByVal Password As String, ByVal ChucDanh As String, ByVal PhongBan As String)
            SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner & ObjectQualifier & "UpdateUser", UserId, FullName, Unit, Street, City, Region, PostalCode, Country, Telephone, Email, Username, GetNull(Password), ChucDanh, PhongBan)
        End Sub
        ...
        Public Overrides Function GetUsersDataSet(ByVal PortalId As Integer, ByVal Filter As String, Optional ByVal NoiDung As String = "", Optional ByVal HinhThuc As String = "") As DataSet
            Return CType(SqlHelper.ExecuteDataset(ConnectionString, DatabaseOwner & ObjectQualifier & "sp_GetUsers", GetNull(PortalId), Filter, NoiDung, HinhThuc), DataSet)
        End Function
        ...
        End Function
        Public Overrides Function GetDMChucDanh() As DataSet
            Return SqlHelper.ExecuteDataset(ConnectionString, DatabaseOwner & ObjectQualifier & "sp_GetDMChucDanh")
        End Function
        Public Overrides Function GetDMPhongBan() As DataSet
            Return SqlHelper.ExecuteDataset(ConnectionString, DatabaseOwner & ObjectQualifier & "sp_GetDMPhongBan")
        End Function
        ' vendors
        ...
        Public Overrides Function GetDanhMucList(ByVal strTableName As String, Optional ByVal strSortExpresion As String = "", Optional ByVal strFilterExpresion As String = "") As DataSet
            Return CType(SqlHelper.ExecuteDataset(ConnectionStringApp, DatabaseOwner & ObjectQualifier & "sp_GetDanhMucComList", GetCommonDB, strTableName, strSortExpresion, strFilterExpresion), DataSet)
        End Function
        ...
        End Function
        Public Overrides Function SearchDanhMuc(ByVal objPage As Object, ByVal strTableName As String) As DataSet
        ...
        End Function
        Public Overrides Function ExecuteScalarAutoByDBName(ByVal DBName As String, ByVal strStoreProc As String, ByVal objControl As Object) As String
            Dim paraValues() As Object
            Dim strConnectionString As String
            GetParamArrayByDB(DBName, strStoreProc, objControl, paraValues)
            strConnectionString = ConfigurationSettings.AppSettings("ConnectionString" & DBName)
            Return CType(SqlHelper.ExecuteScalar(strConnectionString, DatabaseOwner & ObjectQualifier & strStoreProc, paraValues), String)
        End Function
        ...
        Public Sub GetParamArray(ByVal strProcName As String, ByVal objPage As Object, ByRef ParaValues() As Object)
            ...
            ParaValues = arrParam
        End Sub
        Public Sub GetParamArrayByDB(ByVal DBName As String, ByVal strProcName As String, ByVal objPage As Object, ByRef ParaValues() As Object)
            Dim dr As IDataReader
            Dim c As DataColumn
            Dim r As DataRow
            Dim i, j As Integer
            ...
            strConnectString = ConfigurationSettings.AppSettings("ConnectionString" & DBName)
            dr = CType(SqlHelper.ExecuteReader(strConnectString, CommandType.Text, "sp_sproc_columns '" & strProcName & "'"), IDataReader)
            j = 1
            While dr.Read
                For i = 1 To dr.FieldCount - 1
                    If UCase(dr.GetName(i)) = "COLUMN_NAME" Then
                ...
                For Each oControl In CType(obj, Control).Controls
                    Select Case True
                        ...
                        Case TypeOf oControl Is ComboBox
                            If UCase(Mid(CType(oControl, Control).ID, 4)) = UCase(Mid(strPamaName, 3)) Then
                                arr.Add(IIf(CType(oControl, ComboBox).Value = "", Nothing, CType(oControl, ComboBox).Value))
                                intAddArray = 1
                                Exit For
                            End If
        ...
        'Phuocdd: Mar 03 2005
        'Sql Cache
        Public Overrides Sub ClearCacheParameterSet(ByVal connectionString As String, _
                                        ByVal commandText As String)
            SqlHelperParameterCache.ClearCacheParameterSet(connectionString, commandText)
        End Sub
