<%@ Control Language="vb" AutoEventWireup="false" Codebehind="DanhSachGiayPhepXayDung.ascx.vb" Inherits="CPXD.DanhSachGiayPhepXayDung" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
