...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents ddlDuong As ProgStudios.WebControls.ComboBox
        Protected WithEvents ddlPhuong As ProgStudios.WebControls.ComboBox
        Protected WithEvents txtSoToSoThua As System.Web.UI.WebControls.TextBox
...
#End Region
        ...
        Private Sub SetAttributesControl()
            ...
            'txtNgayViPham.Attributes.Add("onblur", "javascript:CheckDateOnBlur(" & Replace(Me.UniqueID, ":", "_") & "_txtNgayViPham);")
            'imgNgayViPham.Attributes.Add("onclick", "javascript:popUpCalendar(this," & Replace(Me.UniqueID, ":", "_") & "_txtNgayViPham, 'dd/mm/yyyy');")
            'txtNgayThiHanh.Attributes.Add("onblur", "javascript:CheckDateOnBlur(" & Replace(Me.UniqueID, ":", "_") & "_txtNgayThiHanh);")
            'imgNgayThiHanh.Attributes.Add("onclick", "javascript:popUpCalendar(this," & Replace(Me.UniqueID, ":", "_") & "_txtNgayThiHanh, 'dd/mm/yyyy');")
            'txtSoQuyetDinh.Attributes.Add("ISNULL", "NOTNULL")
            txtNgayQuyetDinh.Attributes.Add("ISNULL", "NOTNULL")
            'txtNgayViPham.Attributes.Add("ISNULL", "NOTNULL")
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            If Trim(txtSoGiayPhep.Text) = "" And Trim(txtSoCMND.Text) = "" And _
                (Trim(txtSoNha.Text) = "" Or ddlDuong.Value = "" Or ddlPhuong.Value = "") Then
