...
#End Region
        ...
        Private Sub btnChon_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs)
            Response.Redirect(EditURL(, , Request.Params("LoaiHoSo")) & "ID =" & Request.Params("ID"))
        End Sub
