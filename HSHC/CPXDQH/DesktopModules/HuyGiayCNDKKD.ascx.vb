...
#End Region
        ...
        Private Sub SetAttributesControl()
            ...
            strURL = "CPXD/DesktopModules/TimKiemGiayCNDKKD.aspx?IsHuy=1&TabCode=" & CType(Request.Params("TabID"), String) & "&ItemCode=" & CType(Session.Item("ItemCode"), String)
        ...
        Private Sub BindData()
            ...
            gLoadControlValues(objHuyCNDKKD.getHuyGiayCNDKKD(txtSoGiayPhep.Text, txtHoSoTiepNhanID.Text), Me)
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            Dim objHuyCNDKKD As New HuyGiayCNDKKDController
            If objHuyCNDKKD.updHuyGiayCNDKKD(Me) = "1" Then
        ...
        Private Sub btnXoa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnXoa.Click
            Dim objHuyCNDKKD As New HuyGiayCNDKKDController
            Select Case objHuyCNDKKD.delHuyGiayCNDKKD(Me)
                Case "2" : Exit Sub
                Case "1"
