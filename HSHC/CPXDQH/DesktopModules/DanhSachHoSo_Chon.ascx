...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="DanhSachHoSo_Chon.ascx.vb" Inherits="CPXD.DanhSachHoSo_Chon" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="QH_Khung_TopMid" width="*">
						<asp:label id="lblHeader" runat="server" Width="100%" CssClass="QH_Label_Title">&nbsp;</asp:label></td>
