...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            '  Dim strLoai As String = GetParamByID("tab" & Request.Params("tabid"), glbXMLFile)
            Dim objTimKiemGiayCNDKKDInfo As New TimKiemGiayCNDKKDInfo
            Dim objTimKiemGiayCNDKKD As New TimKiemGiayCNDKKDController
            ...
            ds = objTimKiemGiayCNDKKD.DSGiayPhepDauKy(objTimKiemGiayCNDKKDInfo)
