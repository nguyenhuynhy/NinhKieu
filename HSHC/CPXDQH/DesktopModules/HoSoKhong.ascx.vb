...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents chkQuaHan As System.Web.UI.WebControls.CheckBox
...
#End Region
        ...
        Private Sub SetStatusControl(ByVal IsAddNew As Boolean)
            btnDanhSach.Visible = IsAddNew
            lblDanhSach.Visible = Not IsAddNew
        ...
        Private Sub Init_State()
            ...
            txtSoBienNhan.Text = Request.Params("ID")
        ...
        Private Sub btnDanhSach_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDanhSach.Click
        ...
        Private Sub btnIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIn.Click
            ...
            If chkQuaHan.Checked = True Then strFileName = GetParamByID("FileHoSoKhongQuaHan", glbXMLFile)
            ...
            ds = objHoSoKhong.InThongBaoHoSoKhongGiaiQuyet(txtHoSoTiepNhanID.Text)
