...
Namespace CPXD
    ...
    Public Class TiepNhanHoSo
        ...
        Protected WithEvents lblThemChuDauTu As System.Web.UI.WebControls.Label
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            SetFocus(Page, Me.txtNoiDungKhac)
            ...
            GetReportURL(Request.Params("TabId").ToString, CType(Session.Item("ItemCode"), String), "1", strReportPath, btnInBienNhan, Me)
        ...
        Sub Init_State()
            ...
            'imgBarCode.ImageUrl = GetValueItem(Request, "FileTemplate", ConfigurationSettings.AppSettings("Path" & ctype(Session.Item("ActiveDB"),string)) & "GLOBAL.xml")
            'Bind ddl
        ...
        Private Sub btnThemMoi_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnThemMoi.Click
            Dim strURL As String = EditURL("ID", "&Malv=" & txtMaLinhVuc.Text & "&Tenlv=" & Request("Tenlv"))
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCapNhat.Click
            'If Not ViewState("CHUDAUTUREQUIRE") Is Nothing And CStr(ViewState("CHUDAUTUREQUIRE")) <> "FALSE" Then
            ...
            'Else
            'SetMSGBOX_HIDDEN(Me.Page, "Thông tin chủ đầu tư còn thiếu")
            'End If
