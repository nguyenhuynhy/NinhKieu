...
Namespace CPKTQH
    <Serializable()> Public Class ThongTinTraCuuKDInfo
        ...
        Public Sub New(ByVal Request As HttpRequest)
            ...
            glbFile = ConfigurationSettings.AppSettings("Path" & CType(HttpContext.Current.Session.Item("ActiveDB"), String)) & "GLOBAL.xml"
        ...
        Public Function GetInfoFromSearch(ByVal objTTTCInfo As ThongTinTraCuuKDInfo) As DataSet
            Return DataProvider.Instance.ExecuteQueryStoreProc("sp_GetDanhSachHoSo", _
                                                            ...
                                                            objTTTCInfo.LoaiHoSo, objTTTCInfo.TinhTrang, _
                                                             objTTTCInfo.URL)
        End Function
        Public Function GetInfoFromSearchDK(ByVal ParamArray arrParams() As Object) As DataSet
            Return DataProvider.Instance.ExecuteQueryStoreProc("sp_GetDanhSachHoSoDK", arrParams)
        End Function
