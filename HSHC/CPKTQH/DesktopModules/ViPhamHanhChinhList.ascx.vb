...
#Region " Web Form Designer Generated Code "
        ...
        Protected WithEvents btnTìmKiem As System.Web.UI.WebControls.LinkButton
...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            BindControl.BindGrdHoSo(ds, dgdDanhSach, False, "Số quyết định, Số CMND, Địa chỉ, Số GCN ĐKKD", "100,80,300,100", False, True)
        ...
        Private Sub btnTìmKiem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTìmKiem.Click
            dgdDanhSach.CurrentPageIndex = 0
            SetValues()
            LoadGrid()
        End Sub
