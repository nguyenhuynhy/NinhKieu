Imports PortalQH
Namespace CPKTQH
    Public Class NgungKinhDoanhDauKi
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            If Not Page.IsPostBack Then
                ...
                BindData()
                Init_State()
                If txtNgungKinhDoanhID.Text = "" Then
        ...
        Private Sub Init_State()
            'load thong tin giay chung nhan
            Dim objGCN As New GiayCNDKKDController
            Dim ds As DataSet
            ds = objGCN.GetGiayCNDKKDByID(Request.Params("ID"))
            ...
            txtNgungKinhDoanhID.Text = objNgungKD.getNgungKinhDoanhID(txtGiayCNDKKDID.Text, Nothing)

            'trường hợp đã có thông tin ngưng kinh doanh thì load thông tin lên
            txtGhiChu.Text = ""
            If txtNgungKinhDoanhID.Text <> "" Then
                ds = objNgungKD.getNgungKinhDoanh(txtNgungKinhDoanhID.Text)
                gLoadControlValues(ds, Me)
            End If
        ...
        Private Sub btnCapNhat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
            ...
            If Not objNgung.updNgungKinhDoanhDauKi(Me) Then
        ...
        Private Sub btnXoa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnXoa.Click
            Dim objNgung As New NgungKinhDoanhController
            If Not objNgung.delNgungKinhDoanhByID(txtNgungKinhDoanhID.Text) Then
