<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThuLyHoSo.ascx.vb" Inherits="CPKTQH.ThuLyHoSo" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
																...
																<TR>
																	<TD><asp:datagrid id="dgdDanhSach" CssClass="QH_DataGrid" Width="100%" Runat="server" autogeneratecolumns="False"
																			...
																			<Columns>
																				...
																				<asp:TemplateColumn HeaderText="S? bi&#234;n nh?n">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="H? t&#234;n">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="Ð?a ch?">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="Lo?i h? so">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="Ng&#224;y nh?n">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="T&#236;nh tr?ng">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="H?n GQ (ng&#224;y)">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="C&#242;n l?i(Ngày)">
																					<ItemTemplate>
																				...
																				<asp:TemplateColumn HeaderText="S? CMND">
																					<ItemTemplate>
