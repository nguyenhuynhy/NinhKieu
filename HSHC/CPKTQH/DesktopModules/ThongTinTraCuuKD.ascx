<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ThongTinTraCuuKD.ascx.vb" Inherits="CPKTQH.ThongTinTraCuuKD" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
