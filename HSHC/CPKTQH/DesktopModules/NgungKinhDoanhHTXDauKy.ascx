<%@ Control Language="vb" AutoEventWireup="false" Codebehind="NgungKinhDoanhHTXDauKy.ascx.vb" Inherits="CPKTQH.NgungKinhDoanhHTXDauKy" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
												...
												<TD width="100%">
													<TABLE class="QH_LoaiHS" id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
														...
														<TR>
															...
															<TD class="QH_ColControl" width="270" colSpan="4"><asp:label id="lblVonKinhDoanh" CssClass="QH_LabelLeft" Runat="server"></asp:label><asp:label id="Label1" CssClass="QH_LabelLeft" Runat="server">&nbsp;đồng</asp:label></TD>
														</TR>
														<TR>
														...
														<TR>
															...
															<TD class="QH_ColControl" width="150"><asp:label id="lblDiaChiThuongTru" CssClass="QH_LabelLeft" Width="100%" Runat="server"></asp:label></TD>
...
<div style="DISPLAY: none"><asp:textbox id="txtNgungKinhDoanhHTXID" Runat="server" Enabled="False"></asp:textbox><asp:textbox id="txtSoGiayPhep" Runat="server" Enabled="False"></asp:textbox><asp:textbox id="txtGiayCNDKKDHTXID" Runat="server" Enabled="False"></asp:textbox></div>
<script language="javascript">
	var txtNgayKetThuc=document.all("<%=txtNgayKetThuc.clientID%>");
	var imgNgayKetThuc=document.all("<%=imgNgayKetThuc.clientID%>");
	var chkNgayKetThuc = document.all("chkNgayKetThuc");
