...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="NhapDauKyList.ascx.vb" Inherits="CPKTQH.NhapDauKyList" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
		...
		<TD width="100%" height="24">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="QH_Khung_TopMid" width="*"><asp:label id="lblHeader" runat="server" CssClass="QH_Label_Title" Width="100%">Danh sách giấy CN ĐKKD hộ cá thể đầu kì</asp:label>
					</td>
